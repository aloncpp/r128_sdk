...
typedef struct
{
    __IOM unsigned long long MTIMECMP;            /*!< Offset: 0x4000 (R/W) Timer compare register */
    uint32_t RESERVED[8188];
    __IM  unsigned long long MTIME;               /*!< Offset: 0xBFF8 (R)  Timer current register */
} CORET_Type;
...
/* Memory mapping of a523-E906 Hardware */
