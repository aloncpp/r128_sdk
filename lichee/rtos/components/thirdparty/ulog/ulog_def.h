...
#ifdef  CONFIG_ULOG_LINE_BUF_SIZE
#define ULOG_LINE_BUF_SIZE             CONFIG_ULOG_LINE_BUF_SIZE
#else
...
#ifdef CONFIG_ULOG_NEWLINE
#define ULOG_NEWLINE_FLAG              1
#else
#define ULOG_NEWLINE_FLAG              0
#endif
