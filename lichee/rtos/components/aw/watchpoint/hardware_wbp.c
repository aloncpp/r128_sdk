...
static unsigned long read_wb_reg(int n)
{
    unsigned long val = 0;
...
static void write_wb_reg(int n, unsigned long val)
{
    switch (n)
    {
...
{
    unsigned long ctrl = 0x1E7;//0x1E7;
    unsigned long check_value;
