...
#define jiffies_to_msecs(j)     XR_OS_JiffiesToMSecs(j)
#define	msecs_to_jiffies(msec)  XR_OS_MSecsToJiffies(msec)
#elif (defined(CONFIG_OS_NUTTX) || defined(CONFIG_OS_TINA))
#include "kernel/os/os_time.h"
...
/* system clock's frequency, OS ticks per second */
#define HZ                     XR_OS_HZ
//#define XR_OS_HZ               configTICK_RATE_HZ
...
#define msecs_to_jiffies(msec)  XR_OS_MSecsToJiffies(msec)
#define jiffies_to_usecs(t)     ((uint32_t)(t) / (XR_OS_USEC_PER_SEC / XR_OS_TICK))
