...
_ARM_TOOLCHAIN_MELIS_PREFIX_     = "arm-melis-eabi-"
_ARM_TOOLCHAIN_MELIS_GCC_        = "arm-melis-eabi-gcc"
_ARM_TOOLCHAIN_MELIS_NM_         = "arm-melis-eabi-nm"
_ARM_TOOLCHAIN_MELIS_SIZE_       = "arm-melis-eabi-size"
_ARM_TOOLCHAIN_MELIS_OBJDUMP_    = "arm-melis-eabi-objdump"
_ARM_TOOLCHAIN_MELIS_ADDR2LINE_  = "arm-melis-eabi-addr2line"
_ARM_TOOLCHAIN_MELIS_READELF_    = "arm-melis-eabi-readelf"

_ARM_TOOLCHAIN_PREFIX_           = "arm-none-eabi-"
_ARM_TOOLCHAIN_GCC_              = "arm-none-eabi-gcc"
_ARM_TOOLCHAIN_NM_               = "arm-none-eabi-nm"
_ARM_TOOLCHAIN_SIZE_             = "arm-none-eabi-size"
_ARM_TOOLCHAIN_OBJDUMP_          = "arm-none-eabi-objdump"
_ARM_TOOLCHAIN_ADDR2LINE_        = "arm-none-eabi-addr2line"
_ARM_TOOLCHAIN_READELF_          = "arm-none-eabi-readelf"
...
class Core_Dump(object):
    ...
    def get_filelist(self, dir, Filelist):
        Filelist.append(self.elf_file)
        return Filelist

    def getTargetFileName(self, list, pc_addr, try_list):
        try_list.append(self.elf_file)
        return try_list
    ...
    def show(self):
        ...
        for line in log_lines:
            ...
            elif "reg_addr" in line:
                self.parse_addr(line, 1)
            else:
                pass
...
def main():
    ...
    parser.add_argument('-t','--toolchain', help="toolchain config options", default='')
    ...
    elif(toolchain == "arm-melis-eabi"):
        _TOOLCHAIN_PREFIX_          = _ARM_TOOLCHAIN_MELIS_PREFIX_
        _TOOLCHAIN_GCC_             = _ARM_TOOLCHAIN_MELIS_GCC_
        _TOOLCHAIN_NM_              = _ARM_TOOLCHAIN_MELIS_NM_
        _TOOLCHAIN_SIZE_            = _ARM_TOOLCHAIN_MELIS_SIZE_
        _TOOLCHAIN_OBJDUMP_         = _ARM_TOOLCHAIN_MELIS_OBJDUMP_
        _TOOLCHAIN_ADDR2LINE_       = _ARM_TOOLCHAIN_MELIS_ADDR2LINE_
        _TOOLCHAIN_READELF_         = _ARM_TOOLCHAIN_MELIS_READELF_
    else:
