...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("en25qh128",  0x1c7018, 0, 64 * 1024,  256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) },
	{ INFO("en25qx128",  0x1c7118, 0, 64 * 1024,  256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	{
		INFO("gd25q512", 0xc8471a, 0x0, 256 * 1024, 256,
	...
	{ INFO("mx25l6405d",  0xc22017, 0, 64 * 1024, 128, SECT_4K) }, /* same id with mx25l6433f */
	{ INFO("mx25u2033e",  0xc22532, 0, 64 * 1024,   4, SECT_4K) },
	{ INFO("mx25u1635e",  0xc22535, 0, 64 * 1024,  32, SECT_4K) },
	{ INFO("mx25u6435f",  0xc22537, 0, 64 * 1024, 128, SECT_4K) },
	{
		INFO("mx25l12805d", 0xc22018, 0, 64 * 1024, 256,
				SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
				SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_INDIVIDUAL_LOCK)
	}, /* same id with mx25l12833f */
	...
	{ INFO("w25q128", 0xef4018, 0, 64 * 1024, 256,
			SECT_4K |
			//SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) //SPI_NOR_INDIVIDUAL_LOCK的宏会引起写保护，导致uart烧录也失败
	},
	...
	{ INFO("XM25QH256B", 0x206019, 0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_INDIVIDUAL_LOCK)
	},
#endif
	...
	{ INFO("py25q64ha", 0x852017, 0x0, 64 * 1024, 128, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("py25q128ha", 0x852018, 0x0, 64 * 1024, 256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("py25q256ha", 0x852019, 0x0, 64 * 1024, 512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_4B_OPCODES) },
#endif
#ifdef CONFIG_SPI_FLASH_FM		/* FM */
	...
	{ INFO("xt25p1288",  0x0b4018,      0,  64 * 1024, 256, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
	/*BOYA*/
	{ INFO("BY25Q64ES", 0x684017, 0, 64 * 1024,  128, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("BY25Q128ES", 0x684018, 0, 64 * 1024,  256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("BY25Q256FS", 0x684919, 0, 64 * 1024,  512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_4B_OPCODES) },
