...
int board_init(void)
{
	...
	__maybe_unused int work_mode = get_boot_work_mode();
...
#ifndef CONFIG_SUNXI_SRAM_BOOTMODE
	if ((work_mode == WORK_MODE_BOOT) ||
...
#ifdef CONFIG_SUNXI_SET_DRAM
#if CONFIG_SUNXI_DRAM_SIZE
	dram_size = CONFIG_SUNXI_DRAM_SIZE;
#endif
#endif
