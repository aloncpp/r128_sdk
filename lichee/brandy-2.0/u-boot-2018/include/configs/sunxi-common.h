...
#elif defined (CONFIG_MACH_SUN20IW2)
/*sram*/
#if CONFIG_SUNXI_USE_SRAM
#define SDRAM_OFFSET(x) 0x4##x
#define CONFIG_SYS_SDRAM_BASE		0x4000000
#define CONFIG_SYS_LOAD_ADDR		0x4200000 /* default load address */
#define CONFIG_SPL_STACK_R_ADDR		0x4e00000
#define CONFIG_SPL_BSS_START_ADDR	0x4f80000
#define CONFIG_DRAM_PARA_ADDR		SDRAM_OFFSET(800000)
/*hpsram*/
#elif CONFIG_SUNXI_USE_HPSRAM
#define SDRAM_OFFSET(x) 0x0c##x
#define CONFIG_SYS_SDRAM_BASE		0xc000000
#define CONFIG_SYS_LOAD_ADDR		0xc200000 /* default load address */
#define CONFIG_SPL_STACK_R_ADDR		0xce00000
#define CONFIG_SPL_BSS_START_ADDR	0xcf80000
#define CONFIG_DRAM_PARA_ADDR		SDRAM_OFFSET(800000)
/*lpsram*/
#else
#define SDRAM_OFFSET(x) 0x08##x
#define CONFIG_SYS_SDRAM_BASE		0x8000000
#define CONFIG_SYS_LOAD_ADDR		0x8200000 /* default load address */
#define CONFIG_SPL_STACK_R_ADDR		0x8e00000
#define CONFIG_SPL_BSS_START_ADDR	0x8f80000
#define CONFIG_DRAM_PARA_ADDR		SDRAM_OFFSET(800000)
#endif
#else
#define SDRAM_OFFSET(x) 0x4##x
...
#define SUNXI_CFG_TOC1_STORE_IN_DRAM_BASE SDRAM_OFFSET(2e0000)
#else
...
#if defined (CONFIG_SUNXI_RTOS)
#if defined (CONFIG_SUNXI_NOR_IMG)
