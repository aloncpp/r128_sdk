...
#define SPINOR_OP_RDSR1		0x35	/* Read status register 1 for xtx */
#define SPINOR_OP_RDSR2		0x35	/* Read status register 2 for winbond */
#define SPINOR_OP_WRSR2		0x31	/* Write status register 2 for winbond */
#define SPINOR_OP_RDSR3		0x15	/* Read status register 3 for winbond */
#define SPINOR_OP_WRSR3		0x11	/* Write status register 3 for winbond */
#define SPINOR_OP_RDSR2_SANDBOX	0x3f	/* Read status register 2 */
#define SPINOR_OP_WRSR2_SANDBOX	0x3e	/* Write status register 2 */
...
#define SPINOR_OP_RDCR_MX	0x15	/* Read configuration register mxic */
...
#define SPINOR_OP_EN_OTP        0x3a    /* Enter OTP mode */
#define SPINOR_OP_EX_OTP        0x04    /* Write Disable/Exit OTP mode */
...
#define SR3_WPS_WB		BIT(2)  /* Winbond WPS bit */
#define SR3_RCV_WB		BIT(3)  /* Winbond RCV bit */
#define SR2_CMP_GD		BIT(6)  /* Gigadevice CMP bit */
#define SR1_WPS_XTX		BIT(4)  /* Xtx WPS bit */
#define SR2_WPS_FM		BIT(3)  /* Fm WPS bit */
