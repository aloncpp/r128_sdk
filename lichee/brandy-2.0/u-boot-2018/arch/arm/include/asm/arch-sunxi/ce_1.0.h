...
#define SS_N_BASE       0x40004000//SUNXI_SS_BASE              /*non security */
#define SS_S_BASE       (0x40004000_+0x800)      /*security */
#else
#define SS_N_BASE		SUNXI_SS_BASE
#define SS_S_BASE		(SUNXI_SS_BASE + 0x800)
#endif
