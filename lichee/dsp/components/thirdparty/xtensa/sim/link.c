/* link system call for the Xtensa semihosting simulator.  */
...
int
_link_r (struct _reent *reent, const char *oldpath, const char *newpath)
{
  register int a2 __asm__ ("a2") = SYS_link;
