...
#
busybox dos2unix build/mkcommon.sh
busybox dos2unix build/mksetup.sh
busybox dos2unix build/mkcmd.sh
busybox dos2unix pack/build.sh
busybox dos2unix build/envsetup.sh
