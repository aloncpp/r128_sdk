/* This linker script generated from xt-genldscripts.tpp for LSP /home1/zhijinzeng/workPlace/rtos-dev/lichee/dsp/arch/sun20iw2/lsp/dsp0/default */
/* Linker Script for default link */
MEMORY
{
  extra_mem_0_seg :                   	org = 0x0C000000, len = 0x660
  extra_mem_1_seg :                   	org = 0x0C000660, len = 0x9A0
  extra_mem_2_seg :                   	org = 0x0C001000, len = 0x17C
  extra_mem_3_seg :                   	org = 0x0C00117C, len = 0x20
  extra_mem_4_seg :                   	org = 0x0C00119C, len = 0x20
  extra_mem_5_seg :                   	org = 0x0C0011BC, len = 0x20
  extra_mem_6_seg :                   	org = 0x0C0011DC, len = 0x20
  extra_mem_7_seg :                   	org = 0x0C0011FC, len = 0x20
  extra_mem_8_seg :                   	org = 0x0C00121C, len = 0x20
  extra_mem_9_seg :                   	org = 0x0C00123C, len = 0x1C4
  extra_mem_10_seg :                  	org = 0x0C001402, len = 0x7FEBFE
}
...
_memmap_mem_extra_mem_start = 0xc000000;
_memmap_mem_extra_mem_end   = 0xc800000;

/*  Memory segment boundary addresses:  */
_memmap_seg_extra_mem_0_start = 0xc000000;
_memmap_seg_extra_mem_0_max   = 0xc000660;
_memmap_seg_extra_mem_1_start = 0xc000660;
_memmap_seg_extra_mem_1_max   = 0xc001000;
_memmap_seg_extra_mem_2_start = 0xc001000;
_memmap_seg_extra_mem_2_max   = 0xc00117c;
_memmap_seg_extra_mem_3_start = 0xc00117c;
_memmap_seg_extra_mem_3_max   = 0xc00119c;
_memmap_seg_extra_mem_4_start = 0xc00119c;
_memmap_seg_extra_mem_4_max   = 0xc0011bc;
_memmap_seg_extra_mem_5_start = 0xc0011bc;
_memmap_seg_extra_mem_5_max   = 0xc0011dc;
_memmap_seg_extra_mem_6_start = 0xc0011dc;
_memmap_seg_extra_mem_6_max   = 0xc0011fc;
_memmap_seg_extra_mem_7_start = 0xc0011fc;
_memmap_seg_extra_mem_7_max   = 0xc00121c;
_memmap_seg_extra_mem_8_start = 0xc00121c;
_memmap_seg_extra_mem_8_max   = 0xc00123c;
_memmap_seg_extra_mem_9_start = 0xc00123c;
_memmap_seg_extra_mem_9_max   = 0xc001400;
_memmap_seg_extra_mem_10_start = 0xc001402;
_memmap_seg_extra_mem_10_max   = 0xc800000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0xc000660);
PROVIDE(_memmap_vecbase_reset = 0xc001000);
