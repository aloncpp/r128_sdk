...
__xt_mpu_init_table[] __attribute__((section(".ResetHandler.text"))) = {
  ...
  XTHAL_MPU_ENTRY(0x0c000000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_NON_CACHEABLE), // extra_mem
  XTHAL_MPU_ENTRY(0x0c800000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_NON_CACHEABLE), // extra_mem
};
