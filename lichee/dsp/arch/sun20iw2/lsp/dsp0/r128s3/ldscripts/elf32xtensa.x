/* This linker script generated from xt-genldscripts.tpp for LSP /home1/xulu/work/r128-v0.6/lichee/dsp/arch/sun20iw2/lsp/dsp0/r128s3 */
/* Linker Script for default link */
MEMORY
{
  extra_mem_0_seg :                   	org = 0x0D800000, len = 0x660
  extra_mem_1_seg :                   	org = 0x0D800660, len = 0x9A0
  extra_mem_2_seg :                   	org = 0x0D801000, len = 0x17C
  extra_mem_3_seg :                   	org = 0x0D80117C, len = 0x20
  extra_mem_4_seg :                   	org = 0x0D80119C, len = 0x20
  extra_mem_5_seg :                   	org = 0x0D8011BC, len = 0x20
  extra_mem_6_seg :                   	org = 0x0D8011DC, len = 0x20
  extra_mem_7_seg :                   	org = 0x0D8011FC, len = 0x20
  extra_mem_8_seg :                   	org = 0x0D80121C, len = 0x20
  extra_mem_9_seg :                   	org = 0x0D80123C, len = 0x1C4
  extra_mem_10_seg :                  	org = 0x0D801402, len = 0x7FEBFE
}
...
_memmap_mem_extra_mem_start = 0xd800000;
_memmap_mem_extra_mem_end   = 0xe000000;

/*  Memory segment boundary addresses:  */
_memmap_seg_extra_mem_0_start = 0xd800000;
_memmap_seg_extra_mem_0_max   = 0xd800660;
_memmap_seg_extra_mem_1_start = 0xd800660;
_memmap_seg_extra_mem_1_max   = 0xd801000;
_memmap_seg_extra_mem_2_start = 0xd801000;
_memmap_seg_extra_mem_2_max   = 0xd80117c;
_memmap_seg_extra_mem_3_start = 0xd80117c;
_memmap_seg_extra_mem_3_max   = 0xd80119c;
_memmap_seg_extra_mem_4_start = 0xd80119c;
_memmap_seg_extra_mem_4_max   = 0xd8011bc;
_memmap_seg_extra_mem_5_start = 0xd8011bc;
_memmap_seg_extra_mem_5_max   = 0xd8011dc;
_memmap_seg_extra_mem_6_start = 0xd8011dc;
_memmap_seg_extra_mem_6_max   = 0xd8011fc;
_memmap_seg_extra_mem_7_start = 0xd8011fc;
_memmap_seg_extra_mem_7_max   = 0xd80121c;
_memmap_seg_extra_mem_8_start = 0xd80121c;
_memmap_seg_extra_mem_8_max   = 0xd80123c;
_memmap_seg_extra_mem_9_start = 0xd80123c;
_memmap_seg_extra_mem_9_max   = 0xd801400;
_memmap_seg_extra_mem_10_start = 0xd801402;
_memmap_seg_extra_mem_10_max   = 0xe000000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0xd800660);
PROVIDE(_memmap_vecbase_reset = 0xd801000);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xe000000);
  _heap_sentry = 0xe000000;
