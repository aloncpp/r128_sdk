...
#define SUNXI_CCU_M_WITH_MUX_TABLE_GATE_KEY(_struct, _name,			\
					_parents, _table,		\
					_reg,				\
					_mshift, _mwidth,		\
					_muxshift, _muxwidth,		\
...
#define SUNXI_CCU_M_WITH_MUX_GATE_KEY(_struct, _name, _parents, _reg,	\
				  _mshift, _mwidth, _muxshift, _muxwidth, \
				  _key_value, _gate, _flags)			\
	SUNXI_CCU_M_WITH_MUX_TABLE_GATE_KEY(_struct, _name,			\
					_parents, NULL,			\
					_reg, _mshift, _mwidth,		\
					_muxshift, _muxwidth,		\
					_key_value,			\
