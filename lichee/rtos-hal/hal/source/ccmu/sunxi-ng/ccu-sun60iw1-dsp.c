...
/* rst_def_start */
static struct ccu_reset_map SUN60IW1_dsp_resets[] =
{
...
static struct ccu_common *SUN60IW1_dsp_clks[] =
{
...
static const struct sunxi_ccu_desc SUN60IW1_dsp_desc =
{
	.ccu_clks   = SUN60IW1_dsp_clks,
	.num_ccu_clks   = ARRAY_SIZE(SUN60IW1_dsp_clks),

	.hw_clks    = &SUN60IW1_hw_clks,
	.clk_type   = HAL_SUNXI_DSP,

	.resets     = SUN60IW1_dsp_resets,
	.reset_type = HAL_SUNXI_DSP_RESET,
	.num_resets = ARRAY_SIZE(SUN60IW1_dsp_resets),
};
...
int sunxi_dsp_init(void)
{
	...
	ret = ccu_common_init(reg, &SUN60IW1_dsp_desc);
