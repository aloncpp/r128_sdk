...
static CLK_FIXED_FACTOR(rcosc_div32k_clk, "rcosc-div32k", "rcosc-clk", 32, 1, 0);
/* System LFCLK Control Register */
static SUNXI_CCU_GATE(osc32k_en_clk, "osc32k-en", "ext-32k", 0x080, BIT(31), 0);
static SUNXI_CCU_GATE(rc32k_en_clk, "rc32k-en", "fix-losc", 0x080, BIT(30), 0);
static SUNXI_CCU_GATE(rc_hf_en_clk, "rc-hf-en", "rc-hf", 0x080, BIT(29), 0);
static const char *const sys_32k_parents[] = { "lf-sel", "rccal-32k" };
static SUNXI_CCU_MUX(sys_32k_sel_clk, "sys-32k-sel", sys_32k_parents, 0x080, 28, 1, 0);
static const char *const ble_sel_parents[] = { "lf-sel", "rccal-32k" };
static SUNXI_CCU_MUX(ble_sel_clk, "ble-sel", ble_sel_parents, 0x080, 27, 1, 0);
static const char *const sysrtc_sel_parents[] = { "lf-sel", "rccal-32k","hosc-div32k" };
static SUNXI_CCU_MUX(sysrtc32k_clk, "sysrtc32k", sysrtc_sel_parents, 0x080, 25, 2, 0);
static const char *const lf_sel_parents[] = { "rcosc-div32k", "osc32k-en" };
static SUNXI_CCU_MUX(lf_sel_clk, "lf-sel", lf_sel_parents, 0x080, 24, 1, 0);
static const char *const pad_parents[] = {"rcosc-div32k", "osc32k-en", "rccal-32k", "hosc"};
...
static SUNXI_CCU_GATE(rccal32k_clk, "rccal-32k", "rccal-fake-parent", 0x144, BIT(29), 0);
static SUNXI_CCU_GATE(rco_wup_en_clk, "rco-wup-en", "rcosc-div32k", 0x144, BIT(16), 0);
...
static SUNXI_CCU_GATE(auto_switch_en_clk, "32k-auto-en-switch", "div", 0x14c, BIT(0), 0);
...
static struct clk_hw_onecell_data sun20iw2_r_hw_clks =
{
	.hws    = {
		...
		[CLK_RCOSC_DIV_32K]         = &rcosc_div32k_clk.hw,
		...
		[CLK_32K_AUTO_SWITCH]		= &auto_switch_en_clk.common.hw,
	},
	.num    = CLK_R_NUMBER,
};
