...
static struct ccu_sdm_setting pll_audio1_div2_sdm_table[] = {
	{ .rate = 1083801600, .pattern = 0xA000A234, .m = 2, .n = 90 },
	{ .rate = 1179648000, .pattern = 0xA0009BA6, .m = 2, .n = 98 },
};

static struct ccu_nm pll_audio1_div2_clk = {
	.enable		= BIT(27),
	.lock		= BIT(28),
	.n		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.m		= _SUNXI_CCU_DIV(16, 3), /* output divider */
	.sdm		= _SUNXI_CCU_SDM(pll_audio1_div2_sdm_table, BIT(24),
			0x10, BIT(31)),
	.common		= {
		.reg		= 0x000C,
		.features	= CCU_FEATURE_SIGMA_DELTA_MOD,
		.hw.init	= CLK_HW_INIT("pll-audio1-div2", "dcxo24M",
					      &ccu_nm_ops,
					      CLK_SET_RATE_UNGATE |
					      CLK_IS_CRITICAL),
	},
...
static struct ccu_sdm_setting pll_audio1_div5_sdm_table[] = {
	{ .rate = 361267200, .pattern = 0xA000872B, .m = 5, .n = 75 },
	{ .rate = 614400000, .pattern = 0x00000000, .m = 5, .n = 128 },
};

static struct ccu_nm pll_audio1_div5_clk = {
	.enable		= BIT(27),
	.lock		= BIT(28),
	.n		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.m		= _SUNXI_CCU_DIV(20, 3), /* output divider */
	.sdm		= _SUNXI_CCU_SDM(pll_audio1_div5_sdm_table, BIT(24),
			0x10, BIT(31)),
	.common		= {
		.reg		= 0x000C,
		.features	= CCU_FEATURE_SIGMA_DELTA_MOD,
		.hw.init	= CLK_HW_INIT("pll-audio1-div5", "dcxo24M",
					      &ccu_nm_ops,
					      CLK_SET_RATE_UNGATE |
					      CLK_IS_CRITICAL),
	},
...
static const char * const spdif_rx_parents[] = { "pll-peri0-300m", "pll-audio1-div2", "pll-audio1-div5" };
...
{
	.hws    = {
		[CLK_PLL_DSP_AUDIO1_DIV2]		= &pll_audio1_div2_clk.common.hw,
		[CLK_PLL_DSP_AUDIO1_DIV5]		= &pll_audio1_div5_clk .common.hw,
