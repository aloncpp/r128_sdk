...
#if defined(AW_SAVE_LOG_AND_CONTEXT_DUMP_ENABLE)
int32_t log_dump_buffer_alloc(int32_t buffer_size);
#endif
void log_putchar(char byte);

#if defined (AW_DEBUG_LEVEL_NONE)
...
#endif /* AW_DEBUG_LEVEL_NONE */

#if defined(AW_DEBUG_LEVEL_DEBUG)
/**
...
#endif /* AW_DEBUG_LEVEL_DEBUG */

#if defined(AW_DEBUG_LEVEL_INFO)
/**
...
#endif /* AW_DEBUG_LEVEL_INFO */

#if defined(AW_DEBUG_LEVEL_WARNING)
/**
...
#endif /* AW_DEBUG_LEVEL_WARNING */

#if  defined(AW_DEBUG_LEVEL_ERROR)
/**
