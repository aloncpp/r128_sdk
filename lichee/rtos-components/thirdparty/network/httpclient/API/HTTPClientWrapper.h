...
#ifdef CONFIG_COMPONENTS_LWIP_2_1_2
#define		HTTP_EINPROGRESS    (EINPROGRESS)
#define		HTTP_EWOULDBLOCK    (EWOULDBLOCK)
#else
#define		HTTP_EINPROGRESS    115 /* for compatible with old lwip errno version */
#define		HTTP_EWOULDBLOCK    -7
#endif
...
static struct http_resp_header http_resp;
