...
int bt_mesh_input_number(uint32_t num)
{
	...
	(void)memset(bt_mesh_prov_link.auth, 0,
				sizeof(bt_mesh_prov_link.auth) - sizeof(uint32_t));
...
int bt_mesh_input_string(const char *str)
{
	...
	(void)memset(bt_mesh_prov_link.auth + bt_mesh_prov->input_size, 0,
				sizeof(bt_mesh_prov_link.auth) - bt_mesh_prov->input_size);
