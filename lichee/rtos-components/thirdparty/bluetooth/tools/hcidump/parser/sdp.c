...
static const sdp_uuid_nam_lookup_table_t sdp_uuid_nam_lookup_table[] = {
	{ SDP_UUID_SDP,                      "SDP"          },
	{ SDP_UUID_UDP,                      "UDP"          },
...
static const sdp_attr_id_nam_lookup_table_t sdp_attr_id_nam_lookup_table[] = {
...
{
	sdp_pdu_hdr *hdr = (sdp_pdu_hdr *)frm->ptr;
