...
#else
k_thread_stack_t *ecc_thread_stack = NULL;
#endif
...
#endif
	k_thread_create(&ecc_thread_data, ecc_thread_stack,"zbt_hci_ecc",
			/*K_THREAD_STACK_SIZEOF(ecc_thread_stack)*/CONFIG_BT_HCI_ECC_STACK_SIZE, ecc_thread,
			NULL, NULL, NULL, K_PRIO_PREEMPT(28), 0, K_NO_WAIT);
}
