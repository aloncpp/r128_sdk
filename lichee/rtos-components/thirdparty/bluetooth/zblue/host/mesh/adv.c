...
#else
k_thread_stack_t *adv_thread_stack = NULL;
#endif
...
#define ADV_PRIORITY 2  // 2
void bt_mesh_adv_init(void)
{
	k_thread_create(&adv_thread_data, adv_thread_stack,"mesh_adv"
			/*K_THREAD_STACK_SIZEOF(adv_thread_stack)*/ADV_STACK_SIZE, adv_thread,
			NULL, NULL, NULL, K_PRIO_COOP(ADV_PRIORITY), 0, K_NO_WAIT);
}
