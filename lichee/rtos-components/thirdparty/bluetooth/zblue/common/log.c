...
const char *bt_hex_real(const void *buf, size_t len)
{
	...
	static char str[129];	/* !should be optimized */
	const uint8_t *b = buf;
	size_t i;
...
{
	static char str[BT_ADDR_STR_LEN];	/* !should be optimized */
...
{
	static char str[BT_ADDR_LE_STR_LEN];	/* !should be optimized */
...
{
	static char str[BT_UUID_STR_LEN];	/* !should be optimized */
