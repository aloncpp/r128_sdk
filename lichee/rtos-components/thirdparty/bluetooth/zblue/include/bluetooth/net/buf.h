 ...
 */
u8_t net_buf_simple_remove_u8(struct net_buf_simple *buf);
 ...
 */
u16_t net_buf_simple_remove_le16(struct net_buf_simple *buf);
 ...
 */
u16_t net_buf_simple_remove_be16(struct net_buf_simple *buf);
 ...
 */
u32_t net_buf_simple_remove_le24(struct net_buf_simple *buf);
 ...
 */
u32_t net_buf_simple_remove_be24(struct net_buf_simple *buf);
 ...
 */
u32_t net_buf_simple_remove_le32(struct net_buf_simple *buf);
 ...
 */
u32_t net_buf_simple_remove_be32(struct net_buf_simple *buf);
 ...
 */
u64_t net_buf_simple_remove_le48(struct net_buf_simple *buf);
 ...
 */
u64_t net_buf_simple_remove_be48(struct net_buf_simple *buf);
 ...
 */
u64_t net_buf_simple_remove_le64(struct net_buf_simple *buf);
 ...
 */
u64_t net_buf_simple_remove_be64(struct net_buf_simple *buf);
 ...
 */
#if defined(CONFIG_BT_VAR_MEM_DYNC_ALLOC)
#define NET_BUF_POOL_FIXED_DEFINE(_name, _count, _data_size, _destory)        \
	static struct net_buf_pool_fixed net_buf_fixed_##_name = {            \
...
/* reset net buf pool variable */
void net_buf_pool_fixed_deinit(struct net_buf_pool *pool, u32_t _count);
#define NET_BUF_POOL_FIXED_DEINIT(_name, _count, _data_size, _destory)      \
		net_buf_pool_fixed_deinit(_name, _count)
#endif
 ...
 * @return The 8-bit removed value
 */
static inline u8_t net_buf_remove_u8(struct net_buf *buf)
{
 ...
 * @return 16-bit value converted from little endian to host endian.
 */
static inline u16_t net_buf_remove_le16(struct net_buf *buf)
{
 ...
 * @return 16-bit value converted from big endian to host endian.
 */
static inline u16_t net_buf_remove_be16(struct net_buf *buf)
{
 ...
 * @return 24-bit value converted from big endian to host endian.
 */
static inline u32_t net_buf_remove_be24(struct net_buf *buf)
{
 ...
 * @return 24-bit value converted from little endian to host endian.
 */
static inline u32_t net_buf_remove_le24(struct net_buf *buf)
{
 ...
 * @return 32-bit value converted from little endian to host endian.
 */
static inline u32_t net_buf_remove_le32(struct net_buf *buf)
{
 ...
 * @return 32-bit value converted from big endian to host endian.
 */
static inline u32_t net_buf_remove_be32(struct net_buf *buf)
{
 ...
 * @return 48-bit value converted from little endian to host endian.
 */
static inline u64_t net_buf_remove_le48(struct net_buf *buf)
{
 ...
 * @return 48-bit value converted from big endian to host endian.
 */
static inline u64_t net_buf_remove_be48(struct net_buf *buf)
{
 ...
 * @return 64-bit value converted from little endian to host endian.
 */
static inline u64_t net_buf_remove_le64(struct net_buf *buf)
{
 ...
 * @return 64-bit value converted from big endian to host endian.
 */
static inline u64_t net_buf_remove_be64(struct net_buf *buf)
{
