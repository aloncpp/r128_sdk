...
#define BLE_MESH_ADV_QUEUE_SIZE_TEST 150//lwh
...
{
#if !CONFIG_BLE_MESH_FREERTOS_STATIC_ALLOC
    adv_queue.handle = xQueueCreate(BLE_MESH_ADV_QUEUE_SIZE_TEST, sizeof(bt_mesh_msg_t));
    ...
    __ASSERT(adv_task.handle, "Failed to create static adv thread");
     ...
     int ret = xTaskCreateOnCore(adv_thread, BLE_MESH_ADV_TASK_NAME, BLE_MESH_ADV_TASK_STACK_SIZE, NULL,//todo
    ...
    int ret = xTaskCreate(adv_thread, BLE_MESH_ADV_TASK_NAME, BLE_MESH_ADV_TASK_STACK_SIZE, NULL,//todo
