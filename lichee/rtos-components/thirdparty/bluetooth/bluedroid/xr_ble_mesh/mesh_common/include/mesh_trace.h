...
#include "xr_log.h"
#include "mesh_util.h"
#include <stdio.h>//zipmodi
//#include "xr_rom_sys.h"//zipmodi
...
#define BLE_MESH_PRINT_E(tag, format, ...)  {xr_log_write(XR_LOG_ERROR,   tag, LOG_FORMAT(E, format), xr_log_timestamp(), tag, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_W(tag, format, ...)  {xr_log_write(XR_LOG_WARN,    tag, LOG_FORMAT(W, format), xr_log_timestamp(), tag, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_I(tag, format, ...)  {xr_log_write(XR_LOG_INFO,    tag, LOG_FORMAT(I, format), xr_log_timestamp(), tag, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_D(tag, format, ...)  {xr_log_write(XR_LOG_DEBUG,   tag, LOG_FORMAT(D, format), xr_log_timestamp(), tag, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_V(tag, format, ...)  {xr_log_write(XR_LOG_VERBOSE, tag, LOG_FORMAT(V, format), xr_log_timestamp(), tag, ##__VA_ARGS__); }

#define printk         printf // xr_log_write   //xr_rom_printf todo zipmodi
