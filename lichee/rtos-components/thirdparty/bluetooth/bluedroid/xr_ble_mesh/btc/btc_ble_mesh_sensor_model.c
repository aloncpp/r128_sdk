...
#include "xr_ble_mesh_sensor_model_api.h"
...
static inline void btc_ble_mesh_sensor_client_cb_to_app(xr_ble_mesh_sensor_client_cb_event_t event,
                                                        xr_ble_mesh_sensor_client_cb_param_t *param)
{
    xr_ble_mesh_sensor_client_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_sensor_client_cb_t)btc_profile_cb_get(BTC_PID_SENSOR_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_sensor_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_GET_STATE: {
        dst->sensor_client_get_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        dst->sensor_client_get_state.get_state = (xr_ble_mesh_sensor_client_get_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_sensor_client_get_state_t));
        if (dst->sensor_client_get_state.params && dst->sensor_client_get_state.get_state) {
            ...
            case XR_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET:
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_SET_STATE: {
        dst->sensor_client_set_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        dst->sensor_client_set_state.set_state = (xr_ble_mesh_sensor_client_set_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_sensor_client_set_state_t));
        if (dst->sensor_client_set_state.params && dst->sensor_client_set_state.set_state) {
            ...
            memcpy(dst->sensor_client_set_state.set_state, src->sensor_client_set_state.set_state,
                   sizeof(xr_ble_mesh_sensor_client_set_state_t));

            switch (src->sensor_client_set_state.params->opcode) {
            case XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET:
...
{
    xr_ble_mesh_sensor_client_cb_param_t *p_dest_data = (xr_ble_mesh_sensor_client_cb_param_t *)p_dest;
    xr_ble_mesh_sensor_client_cb_param_t *p_src_data = (xr_ble_mesh_sensor_client_cb_param_t *)p_src;
    uint16_t length = 0U;
    ...
    if (p_src_data->params) {
        p_dest_data->params = bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        if (!p_dest_data->params) {
            BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            return;
        }

        memcpy(p_dest_data->params, p_src_data->params, sizeof(xr_ble_mesh_client_common_param_t));
    }

    switch (msg->act) {
    case XR_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT:
    case XR_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT:
    case XR_BLE_MESH_SENSOR_CLIENT_PUBLISH_EVT:
        if (p_src_data->params) {
            switch (p_src_data->params->opcode) {
            case XR_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_COLUMN_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET:
            case XR_BLE_MESH_MODEL_OP_SENSOR_SERIES_STATUS:
    ...
    case XR_BLE_MESH_SENSOR_CLIENT_TIMEOUT_EVT:
        break;
    default:
        break;
    }
...
{
    xr_ble_mesh_sensor_client_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_sensor_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_sensor_client_callback(xr_ble_mesh_sensor_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_sensor_client_cb_param_t),
...
{
    xr_ble_mesh_sensor_client_cb_param_t cb_params = {0};
    xr_ble_mesh_client_common_param_t params = {0};
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_GET_STATE:
        act = XR_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_SET_STATE:
        act = XR_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_PUBLISH:
        act = XR_BLE_MESH_SENSOR_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_TIMEOUT:
        act = XR_BLE_MESH_SENSOR_CLIENT_TIMEOUT_EVT;
        break;
    default:
    ...
    params.model = (xr_ble_mesh_model_t *)model;
...
{
    xr_ble_mesh_client_common_param_t *params = NULL;
    btc_ble_mesh_sensor_client_args_t *arg = NULL;
    xr_ble_mesh_sensor_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            ...
            btc_ble_mesh_sensor_client_callback(&cb, XR_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            /* If send failed, callback error_code to app layer immediately */
            btc_ble_mesh_sensor_client_callback(&cb, XR_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    xr_ble_mesh_sensor_client_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_sensor_client_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_SENSOR_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_sensor_server_cb_to_app(xr_ble_mesh_sensor_server_cb_event_t event,
                                                        xr_ble_mesh_sensor_server_cb_param_t *param)
{
    xr_ble_mesh_sensor_server_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_sensor_server_cb_t)btc_profile_cb_get(BTC_PID_SENSOR_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
{
    xr_ble_mesh_sensor_server_cb_param_t *p_dest_data = (xr_ble_mesh_sensor_server_cb_param_t *)p_dest;
    xr_ble_mesh_sensor_server_cb_param_t *p_src_data = (xr_ble_mesh_sensor_server_cb_param_t *)p_src;
    uint16_t length = 0U;
    ...
    switch (msg->act) {
    case XR_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT:
        if (p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
        ...
        } else if (p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET ||
                   p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET_UNACK) {
        ...
        break;
    case XR_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT:
        if (p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET) {
        ...
        } else if (p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET) {
        ...
        break;
    case XR_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT:
        if (p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                p_src_data->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
...
{
    xr_ble_mesh_sensor_server_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_sensor_server_cb_param_t *)(msg->arg);

    switch (msg->act) {
    case XR_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT:
        if (arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
        ...
        } else if (arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET ||
                   arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET_UNACK) {
            bt_mesh_free_buf(arg->value.state_change.sensor_setting_set.setting_value);
        }
        break;
    case XR_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT:
        if (arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET) {
            bt_mesh_free_buf(arg->value.get.sensor_column.raw_value_x);
        } else if (arg->ctx.recv_op == XR_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET) {
...
static void btc_ble_mesh_sensor_server_callback(xr_ble_mesh_sensor_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_sensor_server_cb_param_t),
...
void bt_mesh_sensor_server_cb_evt_to_btc(uint8_t evt_type, struct bt_mesh_model *model,
                                         ...
                                         const uint8_t *val, size_t len)
{
    xr_ble_mesh_sensor_server_cb_param_t cb_params = {0};
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_STATE_CHANGE:
        act = XR_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_RECV_GET_MSG:
        act = XR_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_RECV_SET_MSG:
        act = XR_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT;
        break;
    default:
    ...
    cb_params.model = (xr_ble_mesh_model_t *)model;
...
{
    xr_ble_mesh_sensor_server_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_sensor_server_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_SENSOR_SERVER_EVT_MAX) {
