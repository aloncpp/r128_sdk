...
static inline void btc_ble_mesh_generic_client_cb_to_app(xr_ble_mesh_generic_client_cb_event_t event,
                                                         xr_ble_mesh_generic_client_cb_param_t *param)
{
    xr_ble_mesh_generic_client_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_generic_client_cb_t)btc_profile_cb_get(BTC_PID_GENERIC_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_generic_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_GENERIC_CLIENT_GET_STATE: {
        dst->generic_client_get_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        ...
        if (src->generic_client_get_state.get_state) {
            dst->generic_client_get_state.get_state = (xr_ble_mesh_generic_client_get_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_generic_client_get_state_t));
            if (dst->generic_client_get_state.get_state) {
                memcpy(dst->generic_client_get_state.get_state, src->generic_client_get_state.get_state,
                    sizeof(xr_ble_mesh_generic_client_get_state_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
        }
    ...
    case BTC_BLE_MESH_ACT_GENERIC_CLIENT_SET_STATE: {
        dst->generic_client_set_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        dst->generic_client_set_state.set_state = (xr_ble_mesh_generic_client_set_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_generic_client_set_state_t));
        if (dst->generic_client_set_state.params && dst->generic_client_set_state.set_state) {
            ...
            memcpy(dst->generic_client_set_state.set_state, src->generic_client_set_state.set_state,
                   sizeof(xr_ble_mesh_generic_client_set_state_t));

            switch (src->generic_client_set_state.params->opcode) {
            case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET:
...
{
    xr_ble_mesh_generic_client_cb_param_t *p_dest_data = (xr_ble_mesh_generic_client_cb_param_t *)p_dest;
    xr_ble_mesh_generic_client_cb_param_t *p_src_data = (xr_ble_mesh_generic_client_cb_param_t *)p_src;
    uint16_t length = 0U;
    ...
    case XR_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT:
        if (p_src_data->params) {
            ...
            case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_GET:
            case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_STATUS:
            ...
            case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET:
            case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_GET:
            case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_STATUS:
            ...
            case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET:
            case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_STATUS:
                ...
                break;
            case XR_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_GET:
            case XR_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_STATUS:
            ...
            case XR_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET:
            case XR_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_STATUS:
            ...
            case XR_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_STATUS:
...
{
    xr_ble_mesh_generic_client_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_generic_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_generic_client_callback(xr_ble_mesh_generic_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_generic_client_cb_param_t),
...
{
    xr_ble_mesh_generic_client_cb_param_t cb_params = {0};
    ...
    case BTC_BLE_MESH_EVT_GENERIC_CLIENT_GET_STATE:
        act = XR_BLE_MESH_GENERIC_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_GENERIC_CLIENT_SET_STATE:
        act = XR_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_GENERIC_CLIENT_PUBLISH:
        act = XR_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_GENERIC_CLIENT_TIMEOUT:
        act = XR_BLE_MESH_GENERIC_CLIENT_TIMEOUT_EVT;
        break;
    default:
...
void btc_ble_mesh_generic_client_call_handler(btc_msg_t *msg)
{
    ...
    btc_ble_mesh_generic_client_args_t *arg = NULL;
    xr_ble_mesh_generic_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_GENERIC_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            ...
            btc_ble_mesh_generic_client_callback(&cb, XR_BLE_MESH_GENERIC_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_GENERIC_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            /* If send failed, callback error_code to app layer immediately */
            btc_ble_mesh_generic_client_callback(&cb, XR_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    xr_ble_mesh_generic_client_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_generic_client_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_GENERIC_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_generic_server_cb_to_app(xr_ble_mesh_generic_server_cb_event_t event,
                                                         xr_ble_mesh_generic_server_cb_param_t *param)
{
    xr_ble_mesh_generic_server_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_generic_server_cb_t)btc_profile_cb_get(BTC_PID_GENERIC_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
{
    xr_ble_mesh_generic_server_cb_param_t *p_dest_data = (xr_ble_mesh_generic_server_cb_param_t *)p_dest;
    xr_ble_mesh_generic_server_cb_param_t *p_src_data = (xr_ble_mesh_generic_server_cb_param_t *)p_src;
    uint16_t length = 0U;
    ...
    case XR_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT:
        ...
        case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET:
        case XR_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET_UNACK:
            ...
            break;
        case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET:
        case XR_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET_UNACK:
...
{
    xr_ble_mesh_generic_server_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_generic_server_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_generic_server_callback(xr_ble_mesh_generic_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_generic_server_cb_param_t),
...
void bt_mesh_generic_server_cb_evt_to_btc(uint8_t evt_type, struct bt_mesh_model *model,
                                          ...
                                          const uint8_t *val, size_t len)
{
    xr_ble_mesh_generic_server_cb_param_t cb_params = {0};
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_EVT_GENERIC_SERVER_STATE_CHANGE:
        act = XR_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT;
        break;
    case BTC_BLE_MESH_EVT_GENERIC_SERVER_RECV_GET_MSG:
        act = XR_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT;
        break;
    case BTC_BLE_MESH_EVT_GENERIC_SERVER_RECV_SET_MSG:
        act = XR_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT;
        break;
    default:
...
{
    xr_ble_mesh_generic_server_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_generic_server_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_GENERIC_SERVER_EVT_MAX) {
