...
static inline void btc_ble_mesh_prov_cb_to_app(xr_ble_mesh_prov_cb_event_t event,
                                               xr_ble_mesh_prov_cb_param_t *param)
{
    xr_ble_mesh_prov_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_prov_cb_t)btc_profile_cb_get(BTC_PID_PROV);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static inline void btc_ble_mesh_model_cb_to_app(xr_ble_mesh_model_cb_event_t event,
                                                xr_ble_mesh_model_cb_param_t *param)
{
    xr_ble_mesh_model_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_model_cb_t)btc_profile_cb_get(BTC_PID_MODEL);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
void btc_ble_mesh_model_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_CLIENT_MODEL_SEND: {
        ...
        dst->model_send.ctx = bt_mesh_malloc(sizeof(xr_ble_mesh_msg_ctx_t));
        ...
        if (dst->model_send.ctx) {
            memcpy(dst->model_send.ctx, src->model_send.ctx, sizeof(xr_ble_mesh_msg_ctx_t));
        } else {
            BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
        }
        break;
    ...
    case BTC_BLE_MESH_ACT_SERVER_MODEL_UPDATE_STATE:
        dst->model_update_state.value = bt_mesh_malloc(sizeof(xr_ble_mesh_server_state_value_t));
        if (dst->model_update_state.value) {
            memcpy(dst->model_update_state.value, src->model_update_state.value,
                   sizeof(xr_ble_mesh_server_state_value_t));
        } else {
            BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
        }
        break;
...
{
    xr_ble_mesh_model_cb_param_t *p_dest_data = (xr_ble_mesh_model_cb_param_t *)p_dest;
    xr_ble_mesh_model_cb_param_t *p_src_data = (xr_ble_mesh_model_cb_param_t *)p_src;
    ...
    switch (msg->act) {
    case XR_BLE_MESH_MODEL_OPERATION_EVT: {
        if (p_src_data->model_operation.ctx && p_src_data->model_operation.msg) {
            p_dest_data->model_operation.ctx = bt_mesh_malloc(sizeof(xr_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->model_operation.ctx) {
                memcpy(p_dest_data->model_operation.ctx, p_src_data->model_operation.ctx, sizeof(xr_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
    ...
    case XR_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT: {
        if (p_src_data->client_recv_publish_msg.ctx && p_src_data->client_recv_publish_msg.msg) {
            p_dest_data->client_recv_publish_msg.ctx = bt_mesh_malloc(sizeof(xr_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->client_recv_publish_msg.ctx) {
                memcpy(p_dest_data->client_recv_publish_msg.ctx, p_src_data->client_recv_publish_msg.ctx, sizeof(xr_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
    ...
    case XR_BLE_MESH_MODEL_SEND_COMP_EVT: {
        if (p_src_data->model_send_comp.ctx) {
            p_dest_data->model_send_comp.ctx = bt_mesh_malloc(sizeof(xr_ble_mesh_msg_ctx_t));
            if (p_dest_data->model_send_comp.ctx) {
                memcpy(p_dest_data->model_send_comp.ctx, p_src_data->model_send_comp.ctx, sizeof(xr_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
        }
    ...
    case XR_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT: {
        if (p_src_data->client_send_timeout.ctx) {
            p_dest_data->client_send_timeout.ctx = bt_mesh_malloc(sizeof(xr_ble_mesh_msg_ctx_t));
            if (p_dest_data->client_send_timeout.ctx) {
                memcpy(p_dest_data->client_send_timeout.ctx, p_src_data->client_send_timeout.ctx, sizeof(xr_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
        }
...
{
    xr_ble_mesh_model_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_model_cb_param_t *)(msg->arg);
...
static bt_status_t btc_ble_mesh_model_callback(xr_ble_mesh_model_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    ret = btc_transfer_context(&msg, param, sizeof(xr_ble_mesh_model_cb_param_t),
...
{
    xr_ble_mesh_model_cb_param_t mesh_param = {0};

    mesh_param.model_operation.opcode = ctx->recv_op;
    mesh_param.model_operation.model = (xr_ble_mesh_model_t *)model;
    mesh_param.model_operation.ctx = (xr_ble_mesh_msg_ctx_t *)ctx;
    mesh_param.model_operation.length = buf->len;
    mesh_param.model_operation.msg = buf->data;

    btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_MODEL_OPERATION_EVT);
    return;
}
                                            ...
                                            struct net_buf_simple *buf)
{
    ...
    if (node == NULL) {
        ...
        mesh_param.client_recv_publish_msg.model = (xr_ble_mesh_model_t *)model;
        mesh_param.client_recv_publish_msg.ctx = (xr_ble_mesh_msg_ctx_t *)ctx;
        mesh_param.client_recv_publish_msg.length = buf->len;
        mesh_param.client_recv_publish_msg.msg = buf->data;
        btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT);
    } else {
        mesh_param.model_operation.opcode = ctx->recv_op;
        mesh_param.model_operation.model = (xr_ble_mesh_model_t *)model;
        mesh_param.model_operation.ctx = (xr_ble_mesh_msg_ctx_t *)ctx;
...
static void btc_ble_mesh_client_model_timeout_cb(struct k_work *work)
{
    ...
    if (timer && !k_delayed_work_free(timer)) {
        ...
        if (node) {
            ...
            mesh_param.client_send_timeout.model = (xr_ble_mesh_model_t *)ctx.model;
            mesh_param.client_send_timeout.ctx = (xr_ble_mesh_msg_ctx_t *)&ctx;
            bt_mesh_client_free_node(node);
            btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT);
        }
    }
...
static void btc_ble_mesh_model_send_comp_cb(xr_ble_mesh_model_t *model,
                                            ...
                                            uint32_t opcode, int err)
{
    ...
    btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_MODEL_SEND_COMP_EVT);
    return;
}

static void btc_ble_mesh_model_publish_comp_cb(xr_ble_mesh_model_t *model, int err)
{
    xr_ble_mesh_model_cb_param_t mesh_param = {0};
    ...
    btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_MODEL_PUBLISH_COMP_EVT);
    return;
}
...
static int btc_ble_mesh_model_publish_update(struct bt_mesh_model *mod)
{
    ...
    mesh_param.model_publish_update.model = (xr_ble_mesh_model_t *)mod;

    ret = btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_MODEL_PUBLISH_UPDATE_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}

#if CONFIG_BLE_MESH_SERVER_MODEL
static void btc_ble_mesh_server_model_update_state_comp_cb(xr_ble_mesh_model_t *model,
                                                           ...
                                                           int err)
{
    ...
    btc_ble_mesh_model_callback(&mesh_param, XR_BLE_MESH_SERVER_MODEL_UPDATE_STATE_COMP_EVT);
    return;
}
#endif /* CONFIG_BLE_MESH_SERVER_MODEL */

static bt_status_t btc_ble_mesh_prov_callback(xr_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    bt_status_t ret = BT_STATUS_SUCCESS;
    ...
    ret = btc_transfer_context(&msg, param, sizeof(xr_ble_mesh_prov_cb_param_t), NULL);
    if (ret != BT_STATUS_SUCCESS) {
        BT_ERR("btc_transfer_context failed");
    }
    return ret;
...
static void btc_ble_mesh_oob_pub_key_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, XR_BLE_MESH_NODE_PROV_OOB_PUB_KEY_EVT);
    return;
}

static int btc_ble_mesh_output_number_cb(bt_mesh_output_action_t act, uint32_t num)
{
    xr_ble_mesh_prov_cb_param_t mesh_param = {0};
    bt_status_t ret = BT_STATUS_SUCCESS;

    BT_DBG("%s", __func__);

    mesh_param.node_prov_output_num.action = (xr_ble_mesh_output_action_t)act;
    mesh_param.node_prov_output_num.number = num;

    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_OUTPUT_NUMBER_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_output_string_cb(const char *str)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_OUTPUT_STRING_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_input_cb(bt_mesh_input_action_t act, uint8_t size)
{
    ...
    mesh_param.node_prov_input.action = (xr_ble_mesh_input_action_t)act;
    mesh_param.node_prov_input.size = size;

    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.node_prov_link_open.bearer = (xr_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_link_close_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.node_prov_link_close.bearer = (xr_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_LINK_CLOSE_EVT);
    return;
}
                                     ...
                                     uint16_t addr, uint8_t flags, uint32_t iv_index)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_NODE_PROV_COMPLETE_EVT);
    return;
}
...
static void btc_ble_mesh_reset_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, XR_BLE_MESH_NODE_PROV_RESET_EVT);
    return;
}
...
static void btc_ble_mesh_prov_register_complete_cb(int err_code)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROV_REGISTER_COMP_EVT);
    return;
}

static void btc_ble_mesh_prov_set_complete_cb(xr_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    BT_DBG("%s", __func__);
                                                            ...
                                                            int8_t rssi)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_RECV_UNPROV_ADV_PKT_EVT);
    return;
}
...
static int btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb(uint8_t link_idx)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
                                                  ...
                                                  uint8_t size, uint8_t link_idx)
{
    ...
    mesh_param.provisioner_prov_input.method = (xr_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_input.action = (xr_ble_mesh_output_action_t)act;
    mesh_param.provisioner_prov_input.size = size;
    mesh_param.provisioner_prov_input.link_idx = link_idx;

    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
                                                   ...
                                                   void *data, uint8_t size, uint8_t link_idx)
{
    ...
    mesh_param.provisioner_prov_output.method = (xr_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_output.action = (xr_ble_mesh_input_action_t)act;
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_OUTPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_provisioner_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.provisioner_prov_link_open.bearer = (xr_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_provisioner_link_close_cb(bt_mesh_prov_bearer_t bearer, uint8_t reason)
{
    ...
    mesh_param.provisioner_prov_link_close.bearer = (xr_ble_mesh_prov_bearer_t)bearer;
    mesh_param.provisioner_prov_link_close.reason = reason;

    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_LINK_CLOSE_EVT);
    return;
}
                                                      ...
                                                      uint16_t netkey_idx)
{
    ...
    memcpy(mesh_param.provisioner_prov_complete.device_uuid, device_uuid, sizeof(xr_ble_mesh_octet16_t));

    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_PROV_COMPLETE_EVT);
    return;
}

xr_ble_mesh_node_t *btc_ble_mesh_provisioner_get_node_with_uuid(const uint8_t uuid[16])
{
    return (xr_ble_mesh_node_t *)bt_mesh_provisioner_get_node_with_uuid(uuid);
}

xr_ble_mesh_node_t *btc_ble_mesh_provisioner_get_node_with_addr(uint16_t unicast_addr)
{
    return (xr_ble_mesh_node_t *)bt_mesh_provisioner_get_node_with_addr(unicast_addr);
}

xr_ble_mesh_node_t *btc_ble_mesh_provisioner_get_node_with_name(const char *name)
{
    return (xr_ble_mesh_node_t *)bt_mesh_provisioner_get_node_with_name(name);
}
...
const xr_ble_mesh_node_t **btc_ble_mesh_provisioner_get_node_table_entry(void)
{
    return (const xr_ble_mesh_node_t **)bt_mesh_provisioner_get_node_table_entry();
}
                                                       ...
                                                       uint8_t hops, uint16_t feat, int8_t rssi)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROVISIONER_RECV_HEARTBEAT_MESSAGE_EVT);
}
...
static void btc_ble_mesh_node_recv_heartbeat_cb(uint8_t hops, uint16_t feature)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_HEARTBEAT_MESSAGE_RECV_EVT);
    return;
}
...
static void btc_ble_mesh_lpn_cb(uint16_t friend_addr, bool established)
{
    ...
    if (established) {
        ...
        act = XR_BLE_MESH_LPN_FRIENDSHIP_ESTABLISH_EVT;
    } else {
        mesh_param.lpn_friendship_terminate.friend_addr = friend_addr;
        act = XR_BLE_MESH_LPN_FRIENDSHIP_TERMINATE_EVT;
    }
                                                  ...
                                                  bt_mesh_proxy_adv_ctx_t *ctx, int8_t rssi)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROXY_CLIENT_RECV_ADV_PKT_EVT);
    return;
}
                                                 ...
                                                 uint8_t conn_handle, uint16_t net_idx)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROXY_CLIENT_CONNECTED_EVT);
    return;
}
                                                    ...
                                                    uint16_t net_idx, uint8_t reason)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROXY_CLIENT_DISCONNECTED_EVT);
    return;
}
                                                            ...
                                                            uint8_t filter_type, uint16_t list_size)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, XR_BLE_MESH_PROXY_CLIENT_RECV_FILTER_STATUS_EVT);
    return;
}
#endif /* CONFIG_BLE_MESH_GATT_PROXY_CLIENT */

int btc_ble_mesh_client_model_init(xr_ble_mesh_model_t *model)
{
    ...
    xr_ble_mesh_model_op_t *op = model->op;
    while (op != NULL && op->opcode != 0) {
        op->param_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_client_model_op_cb;
        op++;
    }
...
int btc_ble_mesh_client_model_deinit(xr_ble_mesh_model_t *model)
{
    return bt_mesh_client_deinit((struct bt_mesh_model *)model);
}
#endif /* CONFIG_BLE_MESH_DEINIT */

int32_t btc_ble_mesh_model_pub_period_get(xr_ble_mesh_model_t *mod)
{
...
uint16_t *btc_ble_mesh_model_find_group(xr_ble_mesh_model_t *mod, uint16_t addr)
{
    return bt_mesh_model_find_group((struct bt_mesh_model *)mod, addr);
}

xr_ble_mesh_elem_t *btc_ble_mesh_elem_find(uint16_t addr)
{
    return (xr_ble_mesh_elem_t *)bt_mesh_elem_find(addr);
}
...
xr_ble_mesh_model_t *btc_ble_mesh_model_find_vnd(const xr_ble_mesh_elem_t *elem,
                                                  uint16_t company, uint16_t id)
{
    return (xr_ble_mesh_model_t *)bt_mesh_model_find_vnd((struct bt_mesh_elem *)elem, company, id);
}

xr_ble_mesh_model_t *btc_ble_mesh_model_find(const xr_ble_mesh_elem_t *elem, uint16_t id)
{
    return (xr_ble_mesh_model_t *)bt_mesh_model_find((struct bt_mesh_elem *)elem, id);
}

const xr_ble_mesh_comp_t *btc_ble_mesh_comp_get(void)
{
    return (const xr_ble_mesh_comp_t *)bt_mesh_comp_get();
}
...
static void btc_ble_mesh_model_op_set(xr_ble_mesh_model_t *model)
{
    if (!model) {
        BT_ERR("%s, Invalid parameter", __func__);
        return;
    ...
    case BLE_MESH_MODEL_ID_CFG_SRV: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_cfg_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_cfg_srv_cb;
    ...
    case BLE_MESH_MODEL_ID_CFG_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_cfg_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_cfg_cli_cb;
    ...
    case BLE_MESH_MODEL_ID_HEALTH_SRV: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_health_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_health_srv_cb;
    ...
    case BLE_MESH_MODEL_ID_HEALTH_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_health_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_health_cli_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_ONOFF_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_onoff_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_LEVEL_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_level_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_def_trans_time_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_onoff_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_level_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_BATTERY_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_battery_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_LOCATION_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_location_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_PROP_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_property_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_generic_client_cb;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lightness_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_lighting_client_cb;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_CTL_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_ctl_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_lighting_client_cb;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_HSL_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_hsl_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_lighting_client_cb;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_XYL_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_xyl_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_lighting_client_cb;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_LC_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lc_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_lighting_client_cb;
    ...
    case BLE_MESH_MODEL_ID_SENSOR_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_sensor_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_sensor_client_cb;
    ...
    case BLE_MESH_MODEL_ID_TIME_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_time_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_time_scene_client_cb;
    ...
    case BLE_MESH_MODEL_ID_SCENE_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scene_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_time_scene_client_cb;
    ...
    case BLE_MESH_MODEL_ID_SCHEDULER_CLI: {
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scheduler_cli_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_time_scene_client_cb;
    ...
    case BLE_MESH_MODEL_ID_GEN_ONOFF_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_onoff_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_onoff_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_LEVEL_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_level_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_level_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_def_trans_time_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_def_trans_time_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_onoff_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_power_onoff_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_onoff_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_power_onoff_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_level_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_power_level_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_power_level_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_power_level_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_BATTERY_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_battery_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_battery_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_LOCATION_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_location_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_location_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_USER_PROP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_user_prop_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_user_prop_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_ADMIN_PROP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_admin_prop_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_admin_prop_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_MANUFACTURER_PROP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_manu_prop_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_manu_prop_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_CLIENT_PROP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_client_prop_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_client_prop_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_LOCATION_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_gen_location_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_gen_location_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    ...
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lightness_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_lightness_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lightness_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_lightness_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_ctl_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_ctl_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_ctl_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_ctl_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_TEMP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_ctl_temp_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_ctl_temp_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_hsl_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_hsl_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_HUE_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_hsl_hue_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_hsl_hue_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SAT_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_hsl_sat_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_hsl_sat_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_hsl_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_hsl_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_XYL_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_xyl_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_xyl_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_XYL_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_xyl_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_xyl_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LC_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lc_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_lc_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LC_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_light_lc_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_light_lc_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    ...
    case BLE_MESH_MODEL_ID_TIME_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_time_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_time_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_TIME_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_time_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_time_setup_srv_cb;
        if (model->pub) {
    ...
    case BLE_MESH_MODEL_ID_SCENE_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scene_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_scene_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCENE_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scene_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_scene_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCHEDULER_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scheduler_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_scheduler_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCHEDULER_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_scheduler_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_scheduler_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    ...
    case BLE_MESH_MODEL_ID_SENSOR_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_sensor_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_sensor_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SENSOR_SETUP_SRV:
        model->op = (xr_ble_mesh_model_op_t *)bt_mesh_sensor_setup_srv_op;
        model->cb = (xr_ble_mesh_model_cbs_t *)&bt_mesh_sensor_setup_srv_cb;
        if (model->pub) {
            model->pub->update = (xr_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
...
set_vnd_op:
    ...
    xr_ble_mesh_model_op_t *op = model->op;
    while (op != NULL && op->opcode != 0) {
        op->param_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_server_model_op_cb;
        op++;
    }
    return;
}
...
{
    xr_ble_mesh_prov_cb_param_t param = {0};
    btc_ble_mesh_prov_args_t *arg = NULL;
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_ACT_MESH_INIT: {
        for (int i = 0; i < arg->mesh_init.comp->element_count; i++) {
            xr_ble_mesh_elem_t *elem = &arg->mesh_init.comp->elements[i];

            for (int j = 0; j < elem->sig_model_count; j++) {
                xr_ble_mesh_model_t *sig_model = &elem->sig_models[j];
            ...
            for (int k = 0; k < elem->vnd_model_count; k++) {
                xr_ble_mesh_model_t *vnd_model = &elem->vnd_models[k];
...
#if CONFIG_BLE_MESH_NODE
        arg->mesh_init.prov->oob_pub_key_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_oob_pub_key_cb;
        arg->mesh_init.prov->output_num_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_output_number_cb;
        arg->mesh_init.prov->output_str_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_output_string_cb;
        arg->mesh_init.prov->input_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_input_cb;
        arg->mesh_init.prov->link_open_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_link_open_cb;
        arg->mesh_init.prov->link_close_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_link_close_cb;
        arg->mesh_init.prov->complete_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_complete_cb;
        arg->mesh_init.prov->reset_cb = (xr_ble_mesh_cb_t)btc_ble_mesh_reset_cb;
#endif /* CONFIG_BLE_MESH_NODE */
#if CONFIG_BLE_MESH_PROVISIONER
        arg->mesh_init.prov->provisioner_prov_read_oob_pub_key = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb;
        arg->mesh_init.prov->provisioner_prov_input = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_input_cb;
        arg->mesh_init.prov->provisioner_prov_output = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_output_cb;
        arg->mesh_init.prov->provisioner_link_open = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_open_cb;
        arg->mesh_init.prov->provisioner_link_close = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_close_cb;
        arg->mesh_init.prov->provisioner_prov_comp = (xr_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_complete_cb;
    ...
    case BTC_BLE_MESH_ACT_SET_OOB_PUB_KEY:
        act = XR_BLE_MESH_NODE_PROV_SET_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_NODE_ADD_LOCAL_NET_KEY:
        act = XR_BLE_MESH_NODE_ADD_LOCAL_NET_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_NODE_ADD_LOCAL_APP_KEY:
        act = XR_BLE_MESH_NODE_ADD_LOCAL_APP_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_NODE_BIND_APP_KEY_TO_MODEL:
        act = XR_BLE_MESH_NODE_BIND_APP_KEY_TO_MODEL_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_DEVICE_NAME:
        act = XR_BLE_MESH_NODE_SET_UNPROV_DEV_NAME_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_READ_OOB_PUB_KEY:
        act = XR_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_STR:
        act = XR_BLE_MESH_PROVISIONER_PROV_INPUT_STRING_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_NUM:
        act = XR_BLE_MESH_PROVISIONER_PROV_INPUT_NUMBER_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ENABLE:
        act = XR_BLE_MESH_PROVISIONER_PROV_ENABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DISABLE:
        act = XR_BLE_MESH_PROVISIONER_PROV_DISABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_ADD: {
        ...
        act = XR_BLE_MESH_PROVISIONER_ADD_UNPROV_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_PROV_DEV_WITH_ADDR:
        act = XR_BLE_MESH_PROVISIONER_PROV_DEV_WITH_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_DEL: {
        ...
        act = XR_BLE_MESH_PROVISIONER_DELETE_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_DEV_UUID_MATCH:
        act = XR_BLE_MESH_PROVISIONER_SET_DEV_UUID_MATCH_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_PROV_DATA_INFO: {
        ...
        act = XR_BLE_MESH_PROVISIONER_SET_PROV_DATA_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_STATIC_OOB_VAL:
        act = XR_BLE_MESH_PROVISIONER_SET_STATIC_OOB_VALUE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_PRIMARY_ELEM_ADDR:
        act = XR_BLE_MESH_PROVISIONER_SET_PRIMARY_ELEM_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_NODE_NAME:
        act = XR_BLE_MESH_PROVISIONER_SET_NODE_NAME_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ADD_LOCAL_APP_KEY: {
        ...
        act = XR_BLE_MESH_PROVISIONER_ADD_LOCAL_APP_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_UPDATE_LOCAL_APP_KEY:
        act = XR_BLE_MESH_PROVISIONER_UPDATE_LOCAL_APP_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_BIND_LOCAL_MOD_APP:
        act = XR_BLE_MESH_PROVISIONER_BIND_APP_KEY_TO_MODEL_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ADD_LOCAL_NET_KEY: {
        ...
        act = XR_BLE_MESH_PROVISIONER_ADD_LOCAL_NET_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_UPDATE_LOCAL_NET_KEY:
        act = XR_BLE_MESH_PROVISIONER_UPDATE_LOCAL_NET_KEY_COMP_EVT;
        ...
        break;
    case BTC_BLE_MESH_ACT_PROVISIONER_STORE_NODE_COMP_DATA:
        act = XR_BLE_MESH_PROVISIONER_STORE_NODE_COMP_DATA_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_NODE_WITH_UUID:
        act = XR_BLE_MESH_PROVISIONER_DELETE_NODE_WITH_UUID_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_NODE_WITH_ADDR:
        act = XR_BLE_MESH_PROVISIONER_DELETE_NODE_WITH_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ENABLE_HEARTBEAT_RECV:
        act = XR_BLE_MESH_PROVISIONER_ENABLE_HEARTBEAT_RECV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_HEARTBEAT_FILTER_TYPE:
        act = XR_BLE_MESH_PROVISIONER_SET_HEARTBEAT_FILTER_TYPE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_HEARTBEAT_FILTER_INFO:
        act = XR_BLE_MESH_PROVISIONER_SET_HEARTBEAT_FILTER_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DIRECT_ERASE_SETTINGS:
        act = XR_BLE_MESH_PROVISIONER_DRIECT_ERASE_SETTINGS_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_OPEN_SETTINGS_WITH_INDEX:
        act = XR_BLE_MESH_PROVISIONER_OPEN_SETTINGS_WITH_INDEX_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_OPEN_SETTINGS_WITH_UID:
        act = XR_BLE_MESH_PROVISIONER_OPEN_SETTINGS_WITH_UID_COMP_EVT;
        strncpy(param.provisioner_open_settings_with_uid_comp.uid,
                arg->open_settings_with_uid.uid, XR_BLE_MESH_SETTINGS_UID_SIZE + 1);
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_CLOSE_SETTINGS_WITH_INDEX:
        act = XR_BLE_MESH_PROVISIONER_CLOSE_SETTINGS_WITH_INDEX_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_CLOSE_SETTINGS_WITH_UID:
        act = XR_BLE_MESH_PROVISIONER_CLOSE_SETTINGS_WITH_UID_COMP_EVT;
        strncpy(param.provisioner_close_settings_with_uid_comp.uid,
                arg->close_settings_with_uid.uid, XR_BLE_MESH_SETTINGS_UID_SIZE + 1);
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_SETTINGS_WITH_INDEX:
        act = XR_BLE_MESH_PROVISIONER_DELETE_SETTINGS_WITH_INDEX_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_SETTINGS_WITH_UID:
        act = XR_BLE_MESH_PROVISIONER_DELETE_SETTINGS_WITH_UID_COMP_EVT;
        strncpy(param.provisioner_delete_settings_with_uid_comp.uid,
                arg->delete_settings_with_uid.uid, XR_BLE_MESH_SETTINGS_UID_SIZE + 1);
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_INFO:
        act = XR_BLE_MESH_SET_FAST_PROV_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_ACTION:
        act = XR_BLE_MESH_SET_FAST_PROV_ACTION_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_DISCONNECT:
        act = XR_BLE_MESH_PROXY_CLIENT_DISCONNECT_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_SET_FILTER_TYPE: {
        ...
        act = XR_BLE_MESH_PROXY_CLIENT_SET_FILTER_TYPE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_ADD_FILTER_ADDR: {
        ...
        act = XR_BLE_MESH_PROXY_CLIENT_ADD_FILTER_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_REMOVE_FILTER_ADDR: {
        ...
        act = XR_BLE_MESH_PROXY_CLIENT_REMOVE_FILTER_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_MODEL_SUBSCRIBE_GROUP_ADDR:
        act = XR_BLE_MESH_MODEL_SUBSCRIBE_GROUP_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_MODEL_UNSUBSCRIBE_GROUP_ADDR:
        act = XR_BLE_MESH_MODEL_UNSUBSCRIBE_GROUP_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_DEINIT_MESH:
        act = XR_BLE_MESH_DEINIT_MESH_COMP_EVT;
...
{
    xr_ble_mesh_prov_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_prov_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_PROV_EVT_MAX) {
...
{
    xr_ble_mesh_model_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_model_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_MODEL_EVT_MAX) {
