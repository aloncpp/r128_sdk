...
typedef union {
    struct ble_mesh_init_args {
        xr_ble_mesh_prov_t *prov;
        xr_ble_mesh_comp_t *comp;
        SemaphoreHandle_t semaphore;
    } mesh_init;
    struct ble_mesh_node_prov_enable_args {
        xr_ble_mesh_prov_bearer_t bearers;
    } node_prov_enable;
    ...
    struct ble_mesh_set_device_name_args {
        char name[XR_BLE_MESH_DEVICE_NAME_MAX_LEN + 1];
    } set_device_name;
    ...
    struct ble_mesh_provisioner_dev_add_args {
        xr_ble_mesh_unprov_dev_add_t add_dev;
    ...
    struct ble_mesh_provisioner_dev_del_args {
        xr_ble_mesh_device_delete_t del_dev;
    } provisioner_dev_del;
    ...
    struct ble_mesh_provisioner_set_prov_net_idx_args {
        xr_ble_mesh_prov_data_info_t prov_data;
    } set_prov_data_info;
    ...
    struct ble_mesh_provisioner_set_node_name_args {
        uint16_t index;
        char name[XR_BLE_MESH_NODE_NAME_MAX_LEN + 1];
    } set_node_name;
    ...
    struct {
        char uid[XR_BLE_MESH_SETTINGS_UID_SIZE + 1];
    ...
    struct ble_mesh_deinit_args {
        xr_ble_mesh_deinit_param_t param;
    } mesh_deinit;
