...
static void btc_ble_mesh_ble_copy_req_data(btc_msg_t *msg, void *p_dst, void *p_src)
{
    ...
    xr_ble_mesh_ble_cb_param_t *p_dst_data = (xr_ble_mesh_ble_cb_param_t *)p_dst;
    xr_ble_mesh_ble_cb_param_t *p_src_data = (xr_ble_mesh_ble_cb_param_t *)p_src;
    ...
    switch (msg->act) {
    case XR_BLE_MESH_SCAN_BLE_ADVERTISING_PKT_EVT:
...
{
#if CONFIG_BLE_MESH_SUPPORT_BLE_SCAN
    xr_ble_mesh_ble_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_ble_cb_param_t *)msg->arg;
...
static void btc_ble_mesh_ble_callback(xr_ble_mesh_ble_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_ble_cb_param_t),
...
{
    xr_ble_mesh_ble_cb_param_t param = {0};
    ...
    btc_ble_mesh_ble_callback(&param, XR_BLE_MESH_SCAN_BLE_ADVERTISING_PKT_EVT);
}
#endif /* CONFIG_BLE_MESH_SUPPORT_BLE_SCAN */
...
void btc_ble_mesh_ble_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_BLE_MESH_ACT_START_BLE_ADV: {
        ...
        btc_ble_mesh_ble_callback(&param, XR_BLE_MESH_START_BLE_ADVERTISING_COMP_EVT);
        break;
    }
    case BTC_BLE_MESH_ACT_STOP_BLE_ADV:
        ...
        btc_ble_mesh_ble_callback(&param, XR_BLE_MESH_STOP_BLE_ADVERTISING_COMP_EVT);
        break;
    ...
    case BTC_BLE_MESH_ACT_START_BLE_SCAN:
        ...
        btc_ble_mesh_ble_callback(&param, XR_BLE_MESH_START_BLE_SCANNING_COMP_EVT);
        break;
    case BTC_BLE_MESH_ACT_STOP_BLE_SCAN:
        param.stop_ble_scan_comp.err_code = bt_mesh_stop_ble_scan();
        btc_ble_mesh_ble_callback(&param, XR_BLE_MESH_STOP_BLE_SCANNING_COMP_EVT);
        break;
#endif /* CONFIG_BLE_MESH_SUPPORT_BLE_SCAN */
    default:
        return;
...
static inline void btc_ble_mesh_ble_cb_to_app(xr_ble_mesh_ble_cb_event_t event,
                                              xr_ble_mesh_ble_cb_param_t *param)
{
    xr_ble_mesh_ble_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_ble_cb_t)btc_profile_cb_get(BTC_PID_BLE_MESH_BLE_COEX);
    if (btc_ble_mesh_cb) {
...
{
    xr_ble_mesh_ble_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_ble_cb_param_t *)msg->arg;

    if (msg->act < XR_BLE_MESH_BLE_EVT_MAX) {
