...
static inline void btc_ble_mesh_config_client_cb_to_app(xr_ble_mesh_cfg_client_cb_event_t event,
                                                        xr_ble_mesh_cfg_client_cb_param_t *param)
{
    xr_ble_mesh_cfg_client_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_cfg_client_cb_t)btc_profile_cb_get(BTC_PID_CONFIG_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_config_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_GET_STATE: {
        dst->cfg_client_get_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        ...
        if (src->cfg_client_get_state.get_state) {
            dst->cfg_client_get_state.get_state = (xr_ble_mesh_cfg_client_get_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_cfg_client_get_state_t));
            if (dst->cfg_client_get_state.get_state) {
                memcpy(dst->cfg_client_get_state.get_state, src->cfg_client_get_state.get_state,
                    sizeof(xr_ble_mesh_cfg_client_get_state_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
        }
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_SET_STATE: {
        dst->cfg_client_set_state.params = (xr_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_client_common_param_t));
        ...
        if (src->cfg_client_set_state.set_state) {
            dst->cfg_client_set_state.set_state = (xr_ble_mesh_cfg_client_set_state_t *)bt_mesh_malloc(sizeof(xr_ble_mesh_cfg_client_set_state_t));
            if (dst->cfg_client_set_state.set_state) {
                memcpy(dst->cfg_client_set_state.set_state, src->cfg_client_set_state.set_state,
                    sizeof(xr_ble_mesh_cfg_client_set_state_t));
            } else {
                BT_ERR("%s, Out of memory, act %d", __func__, msg->act);
            }
        }
...
{
    xr_ble_mesh_cfg_client_cb_param_t *p_dest_data = (xr_ble_mesh_cfg_client_cb_param_t *)p_dest;
    xr_ble_mesh_cfg_client_cb_param_t *p_src_data = (xr_ble_mesh_cfg_client_cb_param_t *)p_src;
    uint16_t length = 0U;
...
{
    xr_ble_mesh_cfg_client_cb_param_t *arg = NULL;
    ...
    arg = (xr_ble_mesh_cfg_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_config_client_callback(xr_ble_mesh_cfg_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_cfg_client_cb_param_t),
...
{
    xr_ble_mesh_cfg_client_cb_param_t cb_params = {0};
    ...
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_GET_STATE:
        act = XR_BLE_MESH_CFG_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_SET_STATE:
        act = XR_BLE_MESH_CFG_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_PUBLISH:
        act = XR_BLE_MESH_CFG_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_TIMEOUT:
        act = XR_BLE_MESH_CFG_CLIENT_TIMEOUT_EVT;
        break;
    default:
...
static int btc_ble_mesh_config_client_get_state(xr_ble_mesh_client_common_param_t *params,
                                                xr_ble_mesh_cfg_client_get_state_t *get)
{
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_PUB_GET:
    case XR_BLE_MESH_MODEL_OP_SIG_MODEL_SUB_GET:
    case XR_BLE_MESH_MODEL_OP_VENDOR_MODEL_SUB_GET:
    case XR_BLE_MESH_MODEL_OP_APP_KEY_GET:
    case XR_BLE_MESH_MODEL_OP_NODE_IDENTITY_GET:
    case XR_BLE_MESH_MODEL_OP_SIG_MODEL_APP_GET:
    case XR_BLE_MESH_MODEL_OP_VENDOR_MODEL_APP_GET:
    case XR_BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_GET:
    case XR_BLE_MESH_MODEL_OP_LPN_POLLTIMEOUT_GET:
        if (get == NULL) {
    ...
    switch (param.opcode) {
    case XR_BLE_MESH_MODEL_OP_BEACON_GET:
        return bt_mesh_cfg_beacon_get(&param);
    case XR_BLE_MESH_MODEL_OP_DEFAULT_TTL_GET:
        return bt_mesh_cfg_ttl_get(&param);
    case XR_BLE_MESH_MODEL_OP_FRIEND_GET:
        return bt_mesh_cfg_friend_get(&param);
    case XR_BLE_MESH_MODEL_OP_GATT_PROXY_GET:
        return bt_mesh_cfg_gatt_proxy_get(&param);
    case XR_BLE_MESH_MODEL_OP_RELAY_GET:
    ...
    case XR_BLE_MESH_MODEL_OP_HEARTBEAT_PUB_GET:
        return bt_mesh_cfg_hb_pub_get(&param);
    case XR_BLE_MESH_MODEL_OP_HEARTBEAT_SUB_GET:
    ...
    case XR_BLE_MESH_MODEL_OP_NET_KEY_GET:
    ...
    case XR_BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_GET:
...
static int btc_ble_mesh_config_client_set_state(xr_ble_mesh_client_common_param_t *params,
                                                xr_ble_mesh_cfg_client_set_state_t *set)
{
    bt_mesh_client_common_param_t param = {0};
    ...
    if (params->opcode != XR_BLE_MESH_MODEL_OP_NODE_RESET && set == NULL) {
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_PUB_SET: {
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_DELETE:
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_OVERWRITE:
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_ADD:
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_OVERWRITE:
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_DELETE:
    ...
    case XR_BLE_MESH_MODEL_OP_MODEL_SUB_DELETE_ALL:
    ...
    case XR_BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_SET:
        return bt_mesh_cfg_kr_phase_set(&param, set->kr_phase_set.net_idx,
                                        set->kr_phase_set.transition);
    case XR_BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_SET:
...
{
    btc_ble_mesh_config_client_args_t *arg = NULL;
    xr_ble_mesh_cfg_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            btc_ble_mesh_config_client_callback(&cb, XR_BLE_MESH_CFG_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            btc_ble_mesh_config_client_callback(&cb, XR_BLE_MESH_CFG_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    xr_ble_mesh_cfg_client_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_cfg_client_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_CFG_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_config_server_cb_to_app(xr_ble_mesh_cfg_server_cb_event_t event,
                                                        xr_ble_mesh_cfg_server_cb_param_t *param)
{
    xr_ble_mesh_cfg_server_cb_t btc_ble_mesh_cb =
        (xr_ble_mesh_cfg_server_cb_t)btc_profile_cb_get(BTC_PID_CONFIG_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static void btc_ble_mesh_config_server_callback(xr_ble_mesh_cfg_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(xr_ble_mesh_cfg_server_cb_param_t), NULL);
}
...
void bt_mesh_config_server_cb_evt_to_btc(uint8_t evt_type, struct bt_mesh_model *model,
                                         ...
                                         const uint8_t *val, size_t len)
{
    xr_ble_mesh_cfg_server_cb_param_t cb_params = {0};
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_EVT_CONFIG_SERVER_STATE_CHANGE:
        act = XR_BLE_MESH_CFG_SERVER_STATE_CHANGE_EVT;
        break;
    default:
...
{
    xr_ble_mesh_cfg_server_cb_param_t *param = NULL;
    ...
    param = (xr_ble_mesh_cfg_server_cb_param_t *)(msg->arg);

    if (msg->act < XR_BLE_MESH_CFG_SERVER_EVT_MAX) {
