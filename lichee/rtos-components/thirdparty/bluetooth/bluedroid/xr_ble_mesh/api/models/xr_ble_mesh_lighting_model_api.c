...
xr_err_t xr_ble_mesh_register_light_client_callback(xr_ble_mesh_light_client_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_LIGHTING_CLIENT, callback) == 0 ? XR_OK : XR_FAIL);
}
                                              ...
                                              xr_ble_mesh_light_client_get_state_t *get_state)
{
    ...
    if (params == NULL || params->model == NULL ||
        ...
        (params->opcode == XR_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_GET && get_state == NULL)) {
...
xr_err_t xr_ble_mesh_register_lighting_server_callback(xr_ble_mesh_lighting_server_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_LIGHTING_SERVER, callback) == 0 ? XR_OK : XR_FAIL);
}
