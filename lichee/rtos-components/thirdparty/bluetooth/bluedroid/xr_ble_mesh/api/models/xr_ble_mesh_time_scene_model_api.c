...
xr_err_t xr_ble_mesh_register_time_scene_client_callback(xr_ble_mesh_time_scene_client_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_TIME_SCENE_CLIENT, callback) == 0 ? XR_OK : XR_FAIL);
}
                                                   ...
                                                   xr_ble_mesh_time_scene_client_get_state_t *get_state)
{
    ...
    if (params == NULL || params->model == NULL ||
        ...
        (params->opcode == XR_BLE_MESH_MODEL_OP_SCHEDULER_ACT_GET && get_state == NULL)) {
...
xr_err_t xr_ble_mesh_register_time_scene_server_callback(xr_ble_mesh_time_scene_server_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_TIME_SCENE_SERVER, callback) == 0 ? XR_OK : XR_FAIL);
}
