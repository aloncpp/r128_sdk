...
#ifndef _XR_BLE_MESH_LOCAL_DATA_OPERATION_API_H_
#define _XR_BLE_MESH_LOCAL_DATA_OPERATION_API_H_
 ...
 *
 */
int32_t xr_ble_mesh_get_model_publish_period(xr_ble_mesh_model_t *model);

/**
 * @brief         Get the address of the primary element.
 *
 * @return        Address of the primary element on success, or
 *                XR_BLE_MESH_ADDR_UNASSIGNED on failure which means the device has not been provisioned.
 *
 */
uint16_t xr_ble_mesh_get_primary_element_address(void);
 ...
 *
 */
uint16_t *xr_ble_mesh_is_model_subscribed_to_group(xr_ble_mesh_model_t *model,
                                                    uint16_t group_addr);
 ...
 *
 */
xr_ble_mesh_elem_t *xr_ble_mesh_find_element(uint16_t element_addr);
 ...
 *
 */
uint8_t xr_ble_mesh_get_element_count(void);
 ...
 *
 */
xr_ble_mesh_model_t *xr_ble_mesh_find_vendor_model(const xr_ble_mesh_elem_t *element,
 ...
 *
 */
xr_ble_mesh_model_t *xr_ble_mesh_find_sig_model(const xr_ble_mesh_elem_t *element,
                                                  uint16_t model_id);
 ...
 *
 */
const xr_ble_mesh_comp_t *xr_ble_mesh_get_composition_data(void);
 ...
 *
 */
xr_err_t xr_ble_mesh_model_subscribe_group_addr(uint16_t element_addr, uint16_t company_id,
 ...
 *
 */
xr_err_t xr_ble_mesh_model_unsubscribe_group_addr(uint16_t element_addr, uint16_t company_id,
                                                    uint16_t model_id, uint16_t group_addr);
 ...
 *
 */
const uint8_t *xr_ble_mesh_node_get_local_net_key(uint16_t net_idx);
 ...
 *
 */
const uint8_t *xr_ble_mesh_node_get_local_app_key(uint16_t app_idx);
 ...
 *
 */
xr_err_t xr_ble_mesh_node_add_local_net_key(const uint8_t net_key[16], uint16_t net_idx);
 ...
 *
 */
xr_err_t xr_ble_mesh_node_add_local_app_key(const uint8_t app_key[16], uint16_t net_idx, uint16_t app_idx);
 ...
 *
 */
xr_err_t xr_ble_mesh_node_bind_app_key_to_local_model(uint16_t element_addr, uint16_t company_id,
...
#endif /* _XR_BLE_MESH_LOCAL_DATA_OPERATION_API_H_ */
