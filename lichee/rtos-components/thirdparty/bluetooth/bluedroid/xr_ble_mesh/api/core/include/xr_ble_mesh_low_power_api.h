...
#ifndef _XR_BLE_MESH_LOW_POWER_API_H_
#define _XR_BLE_MESH_LOW_POWER_API_H_
 ...
 *
 */
xr_err_t xr_ble_mesh_lpn_enable(void);
 ...
 *
 */
xr_err_t xr_ble_mesh_lpn_disable(bool force);
 ...
 *
 */
xr_err_t xr_ble_mesh_lpn_poll(void);

#ifdef __cplusplus
}
#endif

#endif /* _XR_BLE_MESH_LOW_POWER_API_H_ */
