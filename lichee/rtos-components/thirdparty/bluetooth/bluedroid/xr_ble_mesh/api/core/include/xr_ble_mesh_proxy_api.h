...
#ifndef _XR_BLE_MESH_PROXY_API_H_
#define _XR_BLE_MESH_PROXY_API_H_
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_identity_enable(void);
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_gatt_enable(void);
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_gatt_disable(void);
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_client_connect(xr_ble_mesh_bd_addr_t addr,
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_client_disconnect(uint8_t conn_handle);
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_client_set_filter_type(uint8_t conn_handle, uint16_t net_idx,
                                                    xr_ble_mesh_proxy_filter_type_t filter_type);
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_client_add_filter_addr(uint8_t conn_handle, uint16_t net_idx,
 ...
 *
 */
xr_err_t xr_ble_mesh_proxy_client_remove_filter_addr(uint8_t conn_handle, uint16_t net_idx,
                                                       uint16_t *addr, uint16_t addr_num);
...
#endif /* _XR_BLE_MESH_PROXY_API_H_ */
