...
#endif
#ifndef BTC_TASK_NAME
#define BTC_TASK_NAME                   "BTC_TASK"
#endif
#ifndef BTC_TASK_PRIO
...
#if GATTS_INCLUDED == TRUE && GATT_DYNAMIC_MEMORY == TRUE
    if ((btc_creat_tab_env_ptr = (xr_btc_creat_tab_t *)osi_malloc(sizeof(xr_btc_creat_tab_t))) == NULL) {
        goto error_exit;
    }
    memset((void *)btc_creat_tab_env_ptr, 0, sizeof(xr_btc_creat_tab_t));
#if (BLUFI_INCLUDED == TRUE)
