...
#if (BLE_INCLUDED) || defined(CONFIG_BT_DUAL_HOST)
...
#else //zipmodi
#ifndef SCO_HOST_BUFFER_SIZE
#define SCO_HOST_BUFFER_SIZE ((uint8_t)(60))
#endif
#endif
...
static void start_up(void)
{
    ...
    controller_param.simple_pairing_supported &= ssp_flag;
	...
	controller_param.ble_supported = true;//todo
