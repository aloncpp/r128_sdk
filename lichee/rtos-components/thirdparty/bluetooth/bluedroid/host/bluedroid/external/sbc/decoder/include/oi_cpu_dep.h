...
#define OI_CPU_RV64_LEND  21 /**< RV, little-endian */

#ifndef CONFIG_ARCH_RISCV_RV64
#define OI_CPU_TYPE OI_CPU_ARM7_LEND
#else
#define OI_CPU_TYPE OI_CPU_RV64_LEND
#endif
...
#if OI_CPU_TYPE==OI_CPU_RV64_LEND
#define OI_CPU_BYTE_ORDER OI_LITTLE_ENDIAN_BYTE_ORDER

/** @name   little-endian CPU/compiler-dependent primitive data type definitions for the RV64 processor family
 *  @{
 */

typedef signed char     OI_INT8;   /**< 8-bit signed integer values use native signed character data type for RV64 processor. */
typedef signed short    OI_INT16;  /**< 16-bit signed integer values use native signed short integer data type for RV64 processor. */
typedef signed int      OI_INT32;  /**< 32-bit signed integer values use native signed long integer data type for RV64 processor. */
typedef unsigned char   OI_UINT8;  /**< 8-bit unsigned integer values use native unsigned character data type for RV64 processor. */
typedef unsigned short  OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short integer data type for RV64 processor. */
typedef unsigned int    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long integer data type for RV64 processor. */
