...
#else //zipmodi
#define JITTER_BUFFER_WATER_LEVEL (1) //Reduce the chance of underrun, pre 5 frame up to upper layer
#define MAX_OUTPUT_A2DP_SNK_FRAME_QUEUE_SZ     (8 + JITTER_BUFFER_WATER_LEVEL)
#endif
...
static xr_a2d_sink_data_cb_t bt_aa_snk_data_cb = NULL;
...
void btc_a2dp_sink_reg_data_cb(xr_a2d_sink_data_cb_t callback)
{
...
{
#if A2D_DYNAMIC_MEMORY == TRUE
    if (a2dp_sink_local_param_ptr == NULL) {
        return TRUE;
    }
#endif
