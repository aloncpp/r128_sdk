...
#else
//because osi use size define variable, stack need more size
#define BT_BTU_TASK_STACK_SIZE      (UC_BTU_TASK_STACK_SIZE + 4096)
#endif
/******************************************************************************
**
** Classic BT features
...
#define PLC_INCLUDED                FALSE //TRUE //todo
...
#define BTM_SCO_DATA_SIZE_MAX        60 //120 //240 zipmodi
#endif
...
#define BTM_MAX_LOC_BD_NAME_LEN     CONFIG_BREDR_DEVICE_NAME_MAX
#else
