...
static void bta_dm_pm_stop_timer_by_index(tBTA_PM_TIMER *p_timer,
        UINT8 timer_idx);
static UINT8 auto_sniff_mode = 1;
...
/*******************************************************************************
**
** Function         bta_dm_set_auto_enter_sniff_mode
**
** Description      Set whether the host will actively enter sniff mode
**
**
** Returns          void
**
*******************************************************************************/
void bta_dm_set_auto_enter_sniff_mode(tBTA_DM_MSG *p_data)
{
    auto_sniff_mode = p_data->auto_sniff_mode.mode;
}
