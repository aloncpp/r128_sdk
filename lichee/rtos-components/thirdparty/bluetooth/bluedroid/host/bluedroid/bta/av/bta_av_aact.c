...
/*******************************************************************************
**
** Function         bta_av_free_disc_db
**
** Description      Free service discovery database buffer.
**
** Returns          void
**
*******************************************************************************/
static void bta_av_free_disc_db(tBTA_AV_SCB *p_scb)
{
    utl_freebuf((void **) &p_scb->p_disc_db);
    // Clear db pointer to prevent the db pointer from accessing freed memory
    A2D_ClearFindDB();
}
#endif
