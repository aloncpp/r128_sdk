...
const tBTA_DM_ACTION bta_dm_action[BTA_DM_MAX_EVT] = {
    ...
    bta_dm_set_ipscan_param,                /* BTA_DM_API_SET_IPSCAN_PARAM_EVT */
...
#endif
    bta_dm_set_auto_enter_sniff_mode,       /* BTA_DM_API_AUTO_SNIFF_MODE_EVT */
};
...
#if 0 //zipmodi
        xr_coex_status_bit_set(XR_COEX_ST_TYPE_BT, XR_COEX_BT_ST_A2DP_STREAMING);
        xr_coex_status_bit_clear(XR_COEX_ST_TYPE_BT, XR_COEX_BT_ST_A2DP_PAUSED);
#endif
        break;
    case BTA_COEX_EVT_STREAMING_STOPPED:
#if 0 //zipmodi
        xr_coex_status_bit_clear(XR_COEX_ST_TYPE_BT, XR_COEX_BT_ST_A2DP_STREAMING);
        xr_coex_status_bit_clear(XR_COEX_ST_TYPE_BT, XR_COEX_BT_ST_A2DP_PAUSED);
#endif
        break;
    default:
