...
typedef UINT32 tBTA_DM_WIN;        /* inquiry scan or page scan window */
typedef UINT32 tBTA_DM_INT;        /* inquiry scan or page scan interval */
...
typedef tBTM_BL_ROLE_CHG_DATA tBTA_BL_ROLE_CHG_DATA;
...
#define BTA_DM_READ_LOCAL_NAME_EVT      31      /* Read local name */
...
/* Structure associated with BTA_DM_READ_LOCAL_NAME_EVT */
typedef struct {
    UINT8           *name;           /* local name */
} tBTA_DM_READ_LOCAL_NAME;
...
typedef union {
    ...
    tBTA_DM_READ_LOCAL_NAME     read_local_name;    /* read local name event */
...
/* Relate to XR_BLE_SEC_xxx in xr_gatt_defs.h */
#if BLE_INCLUDED == TRUE
...
#define BTA_SERVICE_DXR_LEN    BTA_SERVICE_NAME_LEN
...
**
*******************************************************************************/
extern void BTA_DmGetDeviceName(void);
...
/*******************************************************************************
**
** Function         BTA_DmSetAutoSniffMode
**
** Description      This function set host whether auto enter sniff mode or not.
**
**
** Returns          void
**
*******************************************************************************/
extern void BTA_DmSetAutoSniffMode(uint8_t mode);
...
/*******************************************************************************
**
** Function         BTA_DmSetIpscanParam
**
** Description      This function sets inquiry scan or page scan param
**
** Returns          void
**
*******************************************************************************/
void BTA_DmSetIpscanParam(tBTA_DM_WIN window, tBTA_DM_INT interval, UINT8 type);
...
extern void BTA_DmAddDevice(BD_ADDR bd_addr, DEV_CLASS dev_class,
                            ...
                            UINT8 sc_support, BD_NAME bd_name);
