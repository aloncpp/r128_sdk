...
void rfc_timer_start (tRFC_MCB *p_mcb, UINT16 timeout)
{
    ...
    p_tle->param = (UINT32)(uintptr_t)p_mcb;
...
void rfc_port_timer_start (tPORT *p_port, UINT16 timeout)
{
    ...
    p_tle->param = (UINT32)(uintptr_t)p_port;
...
void rfcomm_process_timeout (TIMER_LIST_ENT  *p_tle)
{
    ...
    case BTU_TTYPE_RFCOMM_MFC:
        rfc_mx_sm_execute ((tRFC_MCB *)(uintptr_t)p_tle->param, RFC_EVENT_TIMEOUT, NULL);
        break;

    case BTU_TTYPE_RFCOMM_PORT:
        rfc_port_sm_execute ((tPORT *)(uintptr_t)p_tle->param, RFC_EVENT_TIMEOUT, NULL);
        break;
