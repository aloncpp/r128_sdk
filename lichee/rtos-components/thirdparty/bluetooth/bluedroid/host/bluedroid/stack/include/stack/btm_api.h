...
/* relate to XR_IO_CAP_xxx in xr_gap_ble_api.h */
...
*/
/* relate to XR_LE_KEY_xxx in xr_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
/* relate to XR_LE_AUTH_xxx in xr_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
**
** Description      This function is called to set a connection into sniffmode.
**                  A check is made if the connection is already in sniff
orpark
