...
// XR vendor group define
#define HCI_XR_GROUP_COMMON    0x01
#define HCI_XR_GROUP_BLE       0x02
#define HCI_XR_GROUP_BT        0x03
#define HCI_XR_GROUP_END       0x07

//XR common subcode define
#define HCI_SUBCODE_COMMON_INIT 0x00
#define HCI_SUBCODE_COMMON_ECHO 0x01
#define HCI_SUBCODE_COMMON_MAX  0x7F

//XR BLE subcode define
...
//XR BT subcode define
#define HCI_SUBCODE_BT_INIT     0x00
#define HCI_SUBCODE_BT_MAX      0x7F

#define HCI_XR_VENDOR_OPCODE_BUILD(ogf, group, subcode) ((ogf << 10) | (group <<7) | (subcode << 0))
/*
* |     OGF     | VENDIOR GROUP | GROUP SUBCODE |
* | 1 1 1 1 1 1 |     0 0 0     | X X X X X X X | Already Exist
* | 1 1 1 1 1 1 |     0 0 1     | X X X X X X X | XR VENDOR COMMON HCI CMD
* | 1 1 1 1 1 1 |     0 1 0     | X X X X X X X | XR VENDOR BLE HCI CMD
* | 1 1 1 1 1 1 |     0 1 1     | X X X X X X X | XR VENDOR BT HCI CMD
...
// XR COMMON HCI CMD
#define HCI_VENDOR_COMMON_ECHO_CMD_OPCODE HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_COMMON, HCI_SUBCODE_COMMON_ECHO)

//XR BLE HCI CMD
/* Multi adv OCF */
#define HCI_BLE_MULTI_ADV_OCF             HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_MULTI_ADV)
/* Batch scan OCF */
#define HCI_BLE_BATCH_SCAN_OCF            HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_BATCH_SCAN)
/* ADV filter OCF */
#define HCI_BLE_ADV_FILTER_OCF            HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_ADV_FILTER)
/* Tracking OCF */
#define HCI_BLE_TRACK_ADV_OCF             HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_TRACK_ADV)
/* Energy info OCF */
#define HCI_BLE_ENERGY_INFO_OCF           HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_ENERGY_INFO)
/* Extended BLE Scan parameters OCF */
#define HCI_BLE_EXTENDED_SCAN_PARAMS_OCF  HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_EXTENDED_SCAN_PARAMS)
/* Long BLE Adv data OCF */
#define HCI_VENDOR_BLE_LONG_ADV_DATA      HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_LONG_ADV)
/* BLE update duplicate scan exceptional list */
#define HCI_VENDOR_BLE_UPDATE_DUPLICATE_EXCEPTIONAL_LIST  HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_DUPLICATE_EXCEPTIONAL_LIST)
#define HCI_VENDOR_BLE_SET_ADV_FLOW_CONTROL        HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_SET_ADV_FLOW_CONTROL)
#define HCI_VENDOR_BLE_ADV_REPORT_FLOW_CONTROL     HCI_XR_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_XR_GROUP_BLE, HCI_SUBCODE_BLE_ADV_REPORT_FLOW_CONTROL)
//XR BT HCI CMD
...
//XR vendor error code
#define HCI_ERR_XR_VENDOR_FAIL                         0xE0
