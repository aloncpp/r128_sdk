...
#ifndef __XR_GAP_BLE_API_H__
#define __XR_GAP_BLE_API_H__
...
typedef uint8_t xr_ble_key_type_t;
...
#define XR_LE_AUTH_REQ_BOND_MITM           (XR_LE_AUTH_BOND | XR_LE_AUTH_REQ_MITM)/*!< 0101*/
...
typedef uint8_t   xr_ble_auth_req_t;         /*!< combination of the above bit pattern */

#define XR_BLE_ONLY_ACCEPT_SPECIFIED_AUTH_DISABLE 0
#define XR_BLE_ONLY_ACCEPT_SPECIFIED_AUTH_ENABLE  1

#define XR_BLE_OOB_DISABLE 0
#define XR_BLE_OOB_ENABLE  1
...
typedef uint8_t xr_ble_io_cap_t;               /*!< combination of the io capability */

/// GAP BLE callback event type
typedef enum {
    XR_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT        = 0,       /*!< When advertising data set complete, the event comes */
    XR_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT,             /*!< When scan response data set complete, the event comes */
    ...
    XR_GAP_BLE_ADV_START_COMPLETE_EVT,                     /*!< When starting advertising complete, the event comes */
    XR_GAP_BLE_SCAN_START_COMPLETE_EVT,                    /*!< When starting scan complete, the event comes */
    ...
    XR_GAP_BLE_ADV_STOP_COMPLETE_EVT,                      /*!< When stopping adv complete, the event comes */
    XR_GAP_BLE_SCAN_STOP_COMPLETE_EVT,                     /*!< When stopping scan complete, the event comes */
    XR_GAP_BLE_SET_STATIC_RAND_ADDR_EVT,                   /*!< When setting the static rand address complete, the event comes */
    XR_GAP_BLE_UPDATE_CONN_PARAMS_EVT,                     /*!< When updating connection parameters complete, the event comes */
    XR_GAP_BLE_SET_PKT_LENGTH_COMPLETE_EVT,                /*!< When setting pkt length complete, the event comes */
    XR_GAP_BLE_SET_LOCAL_PRIVACY_COMPLETE_EVT,             /*!< When enabling/disabling privacy on the local device complete, the event comes */
    XR_GAP_BLE_REMOVE_BOND_DEV_COMPLETE_EVT,               /*!< When removing the bond device complete, the event comes */
    XR_GAP_BLE_CLEAR_BOND_DEV_COMPLETE_EVT,                /*!< When clearing the bond device clear complete, the event comes */
    XR_GAP_BLE_GET_BOND_DEV_COMPLETE_EVT,                  /*!< When getting the bond device list complete, the event comes */
    XR_GAP_BLE_READ_RSSI_COMPLETE_EVT,                     /*!< When reading the rssi complete, the event comes */
    XR_GAP_BLE_UPDATE_WHITELIST_COMPLETE_EVT,              /*!< When adding or removing whitelist complete, the event comes */
    XR_GAP_BLE_UPDATE_DUPLICATE_EXCEPTIONAL_LIST_COMPLETE_EVT,  /*!< When updating duplicate exceptional list complete, the event comes */
    XR_GAP_BLE_SET_CHANNELS_EVT,                           /*!< When setting BLE channels complete, the event comes */
    XR_GAP_BLE_EVT_MAX,
} xr_gap_ble_cb_event_t;

#define XR_GAP_BLE_CHANNELS_LEN     5
typedef uint8_t xr_gap_ble_channels[XR_GAP_BLE_CHANNELS_LEN];
...
typedef enum {
    XR_BLE_SEC_ENCRYPT = 1,            /* relate to BTA_DM_BLE_SEC_ENCRYPT in bta/bta_api.h. If the device has already
                                           ...
                                           used the xr_ble_gap_set_security_param function set by the user. */
    XR_BLE_SEC_ENCRYPT_NO_MITM,        /* relate to BTA_DM_BLE_SEC_ENCRYPT_NO_MITM in bta/bta_api.h. If the device has already
                                           ...
                                           used the authreq in the xr_ble_gap_set_security_param function set by the user. */
...
typedef enum {
    ...
    XR_BLE_SM_MIN_KEY_SIZE,
    /* Set static Passkey */
    XR_BLE_SM_SET_STATIC_PASSKEY,
    /* Reset static Passkey */
    XR_BLE_SM_CLEAR_STATIC_PASSKEY,
    /* Accept only specified SMP Authentication requirement */
    XR_BLE_SM_ONLY_ACCEPT_SPECIFIED_SEC_AUTH,
    /* Enable/Disable OOB support */
    XR_BLE_SM_OOB_SUPPORT,
    /* Appl encryption key size */
    XR_BLE_APP_ENC_KEY_SIZE,
    XR_BLE_SM_MAX_PARAM,
} xr_ble_sm_param_t;
...
typedef struct {
    ...
    xr_ble_adv_type_t      adv_type;           /*!< Advertising type */
    xr_ble_addr_type_t     own_addr_type;      /*!< Owner bluetooth device address type */
    xr_bd_addr_t           peer_addr;          /*!< Peer device bluetooth device address */
    xr_ble_addr_type_t     peer_addr_type;     /*!< Peer device bluetooth device address type, only support public address type and random address type */
    xr_ble_adv_channel_t   channel_map;        /*!< Advertising channel map */
    xr_ble_adv_filter_t    adv_filter_policy;  /*!< Advertising filter policy */
} xr_ble_adv_params_t;
...
} xr_ble_scan_duplicate_t;

/// Ble scan parameters
typedef struct {
    xr_ble_scan_type_t     scan_type;              /*!< Scan type */
    xr_ble_addr_type_t     own_addr_type;          /*!< Owner address type */
    xr_ble_scan_filter_t   scan_filter_policy;     /*!< Scan filter policy */
    ...
    xr_ble_scan_duplicate_t  scan_duplicate;       /*!< The Scan_Duplicates parameter controls whether the Link Layer should filter out
                                                        duplicate advertising reports (BLE_SCAN_DUPLICATE_ENABLE) to the Host, or if the Link Layer should generate
                                                        advertising reports for each packet received */
} xr_ble_scan_params_t;
...
} xr_gap_conn_params_t;

/// Connection update parameters
typedef struct {
    xr_bd_addr_t bda;                              /*!< Bluetooth device address */
...
}xr_ble_pkt_data_length_params_t;
...
typedef struct
{
    xr_bt_octet16_t     ltk;          /*!< The long term key*/
    xr_bt_octet8_t      rand;         /*!< The random number*/
...
} xr_ble_penc_keys_t;                 /*!< The key type*/
...
typedef struct
{
    ...
    xr_bt_octet16_t    csrk;         /*!< The csrk key */
    uint8_t             sec_level;    /*!< The security level */
} xr_ble_pcsrk_keys_t;               /*!< The pcsrk key type */
...
typedef struct
{
    xr_bt_octet16_t          irk;           /*!< The irk value */
    xr_ble_addr_type_t       addr_type;     /*!< The address type */
    xr_bd_addr_t             static_addr;   /*!< The static address */
} xr_ble_pid_keys_t;                        /*!< The pid key type */
...
typedef struct
{
    ...
    uint8_t           sec_level;            /*!< The security level of the security link */
} xr_ble_lenc_keys_t;                      /*!< The  key type */
...
typedef struct
{
    ...
    uint16_t          div;                  /*!< The div value */
    uint8_t           sec_level;            /*!< The security level of the security link */
    xr_bt_octet16_t  csrk;                 /*!< The csrk key value */
} xr_ble_lcsrk_keys;                       /*!< The csrk key type */
...
{
    xr_bd_addr_t  bd_addr;        /*!< peer address */
} xr_ble_sec_req_t;               /*!< BLE security request type*/
...
typedef union
{
    xr_ble_penc_keys_t   penc_key;       /*!< received peer encryption key */
    xr_ble_pcsrk_keys_t  pcsrk_key;      /*!< received peer device SRK */
    xr_ble_pid_keys_t    pid_key;        /*!< peer device ID key */
    xr_ble_lenc_keys_t   lenc_key;       /*!< local encryption reproduction keys LTK = = d1(ER,DIV,0)*/
    xr_ble_lcsrk_keys    lcsrk_key;      /*!< local device CSRK = d1(ER,DIV,1)*/
} xr_ble_key_value_t;                    /*!< ble key value type*/
...
typedef struct
{
    xr_ble_key_mask_t    key_mask;       /*!< the key mask to indicate witch key is present */
    xr_ble_penc_keys_t   penc_key;       /*!< received peer encryption key */
    xr_ble_pcsrk_keys_t  pcsrk_key;      /*!< received peer device SRK */
    xr_ble_pid_keys_t    pid_key;        /*!< peer device ID key */
} xr_ble_bond_key_info_t;                /*!< ble bond key information value type */
...
{
    xr_bd_addr_t  bd_addr;               /*!< peer address */
    xr_ble_bond_key_info_t bond_key;     /*!< the bond key information */
} xr_ble_bond_dev_t;                     /*!< the ble bond device type */
...
{
    xr_bd_addr_t               bd_addr;        /*!< peer address */
    xr_ble_key_type_t          key_type;       /*!< key type of the security link */
    xr_ble_key_value_t         p_key_value;    /*!< the pointer to the key value */
} xr_ble_key_t;                                /*!< the union to the ble key value type*/

/**
* @brief  structure type of the ble local id keys value
*/
typedef struct {
    xr_bt_octet16_t       ir;                  /*!< the 16 bits of the ir value */
    xr_bt_octet16_t       irk;                 /*!< the 16 bits of the ir key value */
    xr_bt_octet16_t       dhk;                 /*!< the 16 bits of the dh key value */
} xr_ble_local_id_keys_t;                      /*!< the structure of the ble local id keys value type*/
...
typedef struct
{
    xr_bd_addr_t         bd_addr;               /*!< BD address peer device. */
    bool                  key_present;           /*!< Valid link key value in key element */
    xr_link_key          key;                   /*!< Link key associated with peer device. */
    uint8_t               key_type;              /*!< The type of Link Key */
    bool                  success;               /*!< TRUE of authentication succeeded, FALSE if failed. */
    uint8_t               fail_reason;           /*!< The HCI reason/error code for when success=FALSE */
    xr_ble_addr_type_t   addr_type;             /*!< Peer device address type */
    xr_bt_dev_type_t     dev_type;              /*!< Device type */
    xr_ble_auth_req_t    auth_mode;             /*!< authentication mode */
} xr_ble_auth_cmpl_t;                           /*!< The ble authentication complete cb type */
...
typedef union
{
    xr_ble_sec_key_notif_t    key_notif;      /*!< passkey notification */
    xr_ble_sec_req_t          ble_req;        /*!< BLE SMP related request */
    xr_ble_key_t              ble_key;        /*!< BLE SMP keys used when pairing */
    xr_ble_local_id_keys_t    ble_id_keys;    /*!< BLE IR event */
    xr_ble_auth_cmpl_t        auth_cmpl;      /*!< Authentication complete indication. */
} xr_ble_sec_t;                               /*!< BLE security type */
...
typedef enum {
    ...
    XR_GAP_SEARCH_INQ_DISCARD_NUM_EVT     = 7,      /*!< The number of pkt discarded by flow control */
} xr_gap_search_evt_t;
...
typedef enum {
    ...
    XR_BLE_EVT_SCAN_RSP         = 0x04,        /*!< Scan Response (SCAN_RSP) */
} xr_ble_evt_type_t;

typedef enum{
    XR_BLE_WHITELIST_REMOVE     = 0X00,    /*!< remove mac from whitelist */
    XR_BLE_WHITELIST_ADD        = 0X01,    /*!< add address to whitelist */
}xr_ble_wl_opration_t;

typedef enum {
    XR_BLE_DUPLICATE_EXCEPTIONAL_LIST_ADD      = 0,  /*!< Add device info into duplicate scan exceptional list */
    XR_BLE_DUPLICATE_EXCEPTIONAL_LIST_REMOVE,        /*!< Remove device info from duplicate scan exceptional list */
    XR_BLE_DUPLICATE_EXCEPTIONAL_LIST_CLEAN,         /*!< Clean duplicate scan exceptional list */
} xr_bt_duplicate_exceptional_subcode_type_t;

#define BLE_BIT(n) (1UL<<(n))

typedef enum {
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_INFO_ADV_ADDR       = 0,  /*!< BLE advertising address , device info will be added into XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_ADDR_LIST */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_INFO_MESH_LINK_ID,        /*!< BLE mesh link ID, it is for BLE mesh, device info will be added into XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_MESH_LINK_ID_LIST */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_INFO_MESH_BEACON_TYPE,    /*!< BLE mesh beacon AD type, the format is | Len | 0x2B | Beacon Type | Beacon Data | */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_INFO_MESH_PROV_SRV_ADV,   /*!< BLE mesh provisioning service uuid, the format is | 0x02 | 0x01 | flags | 0x03 | 0x03 | 0x1827 | .... |` */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_INFO_MESH_PROXY_SRV_ADV,  /*!< BLE mesh adv with proxy service uuid, the format is | 0x02 | 0x01 | flags | 0x03 | 0x03 | 0x1828 | .... |` */
} xr_ble_duplicate_exceptional_info_type_t;

typedef enum {
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_ADDR_LIST                  = BLE_BIT(0),             /*!< duplicate scan exceptional addr list */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_MESH_LINK_ID_LIST          = BLE_BIT(1),             /*!< duplicate scan exceptional mesh link ID list */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_MESH_BEACON_TYPE_LIST      = BLE_BIT(2),             /*!< duplicate scan exceptional mesh beacon type list */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_MESH_PROV_SRV_ADV_LIST     = BLE_BIT(3),             /*!< duplicate scan exceptional mesh adv with provisioning service uuid */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_MESH_PROXY_SRV_ADV_LIST    = BLE_BIT(4),             /*!< duplicate scan exceptional mesh adv with provisioning service uuid */
    XR_BLE_DUPLICATE_SCAN_EXCEPTIONAL_ALL_LIST                   = 0xFFFF,                 /*!< duplicate scan exceptional all list */
} xr_duplicate_scan_exceptional_list_type_t;

typedef uint8_t xr_duplicate_info_t[XR_BD_ADDR_LEN];
...
typedef union {
    /**
     * @brief XR_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT
     */
    struct ble_adv_data_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set advertising data operation success status */
    } adv_data_cmpl;                                /*!< Event parameter of XR_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT
     */
    struct ble_scan_rsp_data_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set scan response data operation success status */
    } scan_rsp_data_cmpl;                           /*!< Event parameter of XR_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SCAN_PARAM_SET_COMPLETE_EVT
     */
    struct ble_scan_param_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set scan param operation success status */
    } scan_param_cmpl;                              /*!< Event parameter of XR_GAP_BLE_SCAN_PARAM_SET_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SCAN_RESULT_EVT
     */
    struct ble_scan_result_evt_param {
        xr_gap_search_evt_t search_evt;            /*!< Search event type */
        xr_bd_addr_t bda;                          /*!< Bluetooth device address which has been searched */
        xr_bt_dev_type_t dev_type;                 /*!< Device type */
        xr_ble_addr_type_t ble_addr_type;          /*!< Ble device address type */
        xr_ble_evt_type_t ble_evt_type;            /*!< Ble scan result event type */
    ...
    /**
     * @brief XR_GAP_BLE_ADV_DATA_RAW_SET_COMPLETE_EVT
     */
    struct ble_adv_data_raw_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set raw advertising data operation success status */
    } adv_data_raw_cmpl;                            /*!< Event parameter of XR_GAP_BLE_ADV_DATA_RAW_SET_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SCAN_RSP_DATA_RAW_SET_COMPLETE_EVT
     */
    struct ble_scan_rsp_data_raw_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set raw advertising data operation success status */
    } scan_rsp_data_raw_cmpl;                       /*!< Event parameter of XR_GAP_BLE_SCAN_RSP_DATA_RAW_SET_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_ADV_START_COMPLETE_EVT
     */
    struct ble_adv_start_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate advertising start operation success status */
    } adv_start_cmpl;                               /*!< Event parameter of XR_GAP_BLE_ADV_START_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SCAN_START_COMPLETE_EVT
     */
    struct ble_scan_start_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate scan start operation success status */
    } scan_start_cmpl;                              /*!< Event parameter of XR_GAP_BLE_SCAN_START_COMPLETE_EVT */

    xr_ble_sec_t ble_security;                     /*!< ble gap security union type */
    /**
     * @brief XR_GAP_BLE_SCAN_STOP_COMPLETE_EVT
     */
    struct ble_scan_stop_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate scan stop operation success status */
    } scan_stop_cmpl;                               /*!< Event parameter of XR_GAP_BLE_SCAN_STOP_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_ADV_STOP_COMPLETE_EVT
     */
    struct ble_adv_stop_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate adv stop operation success status */
    } adv_stop_cmpl;                                /*!< Event parameter of XR_GAP_BLE_ADV_STOP_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SET_STATIC_RAND_ADDR_EVT
     */
    struct ble_set_rand_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate set static rand address operation success status */
    } set_rand_addr_cmpl;                           /*!< Event parameter of XR_GAP_BLE_SET_STATIC_RAND_ADDR_EVT */
    /**
     * @brief XR_GAP_BLE_UPDATE_CONN_PARAMS_EVT
     */
    struct ble_update_conn_params_evt_param {
        xr_bt_status_t status;                    /*!< Indicate update connection parameters success status */
        xr_bd_addr_t bda;                         /*!< Bluetooth device address */
        uint16_t min_int;                          /*!< Min connection interval */
        uint16_t max_int;                          /*!< Max connection interval */
        uint16_t latency;                          /*!< Slave latency for the connection in number of connection events. Range: 0x0000 to 0x01F3 */
    ...
    /**
     * @brief XR_GAP_BLE_SET_PKT_LENGTH_COMPLETE_EVT
     */
    struct ble_pkt_data_length_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set pkt data length operation success status */
        xr_ble_pkt_data_length_params_t params;    /*!<  pkt data length value */
    } pkt_data_lenth_cmpl;                          /*!< Event parameter of XR_GAP_BLE_SET_PKT_LENGTH_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SET_LOCAL_PRIVACY_COMPLETE_EVT
     */
    struct ble_local_privacy_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the set local privacy operation success status */
    } local_privacy_cmpl;                           /*!< Event parameter of XR_GAP_BLE_SET_LOCAL_PRIVACY_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_REMOVE_BOND_DEV_COMPLETE_EVT
     */
    struct ble_remove_bond_dev_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the remove bond device operation success status */
        xr_bd_addr_t bd_addr;                      /*!< The device address which has been remove from the bond list */
    }remove_bond_dev_cmpl;                          /*!< Event parameter of XR_GAP_BLE_REMOVE_BOND_DEV_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_CLEAR_BOND_DEV_COMPLETE_EVT
     */
    struct ble_clear_bond_dev_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the clear bond device operation success status */
    }clear_bond_dev_cmpl;                           /*!< Event parameter of XR_GAP_BLE_CLEAR_BOND_DEV_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_GET_BOND_DEV_COMPLETE_EVT
     */
    struct ble_get_bond_dev_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the get bond device operation success status */
        uint8_t dev_num;                            /*!< Indicate the get number device in the bond list */
        xr_ble_bond_dev_t *bond_dev;               /*!< the pointer to the bond device Structure */
    }get_bond_dev_cmpl;                             /*!< Event parameter of XR_GAP_BLE_GET_BOND_DEV_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_READ_RSSI_COMPLETE_EVT
     */
    struct ble_read_rssi_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the read adv tx power operation success status */
        ...
        xr_bd_addr_t remote_addr;                  /*!< The remote device address */
    } read_rssi_cmpl;                               /*!< Event parameter of XR_GAP_BLE_READ_RSSI_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_UPDATE_WHITELIST_COMPLETE_EVT
     */
    struct ble_update_whitelist_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate the add or remove whitelist operation success status */
        xr_ble_wl_opration_t wl_opration;          /*!< The value is XR_BLE_WHITELIST_ADD if add address to whitelist operation success, XR_BLE_WHITELIST_REMOVE if remove address from the whitelist operation success */
    } update_whitelist_cmpl;                        /*!< Event parameter of XR_GAP_BLE_UPDATE_WHITELIST_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_UPDATE_DUPLICATE_EXCEPTIONAL_LIST_COMPLETE_EVT
     */
    struct ble_update_duplicate_exceptional_list_cmpl_evt_param {
        xr_bt_status_t status;                     /*!< Indicate update duplicate scan exceptional list operation success status */
        uint8_t         subcode;                    /*!< Define in xr_bt_duplicate_exceptional_subcode_type_t */
        uint16_t         length;                     /*!< The length of device_info */
        xr_duplicate_info_t device_info;           /*!< device information, when subcode is XR_BLE_DUPLICATE_EXCEPTIONAL_LIST_CLEAN, the value is invalid */
    } update_duplicate_exceptional_list_cmpl;       /*!< Event parameter of XR_GAP_BLE_UPDATE_DUPLICATE_EXCEPTIONAL_LIST_COMPLETE_EVT */
    /**
     * @brief XR_GAP_BLE_SET_CHANNELS_EVT
     */
    struct ble_set_channels_evt_param {
        xr_bt_status_t stat;                       /*!< BLE set channel status */
    } ble_set_channels;                             /*!< Event parameter of XR_GAP_BLE_SET_CHANNELS_EVT */
} xr_ble_gap_cb_param_t;
 ...
 */
typedef void (* xr_gap_ble_cb_t)(xr_gap_ble_cb_event_t event, xr_ble_gap_cb_param_t *param);
 ...
 *                 uint8_t *xr_bt_dev_get_address(void) get the public address
 *
 ...
 *                  XR_GAP_BLE_READ_RSSI_COMPLETE_EVT event.
 *
 ...
 *
 *
 * @param[in]       type: device info type, it is defined in xr_ble_duplicate_exceptional_info_type_t
 ...
 *
 *
 * @param[in]       list_type: duplicate scan exceptional list type, the value can be one or more of xr_duplicate_scan_exceptional_list_type_t.
 *
 * @return
 *                  - XR_OK : success
 *                  - other  : failed
...
*
*                    1. Set bit `XR_LE_AUTH_REQ_SC_ONLY` (`param_type` is
*                    `XR_BLE_SM_AUTHEN_REQ_MODE`), bit `XR_LE_AUTH_BOND` and bit
*                    `XR_LE_AUTH_REQ_MITM` is optional as required.
*
*                    2. Set to `XR_BLE_ONLY_ACCEPT_SPECIFIED_AUTH_ENABLE` (`param_type` is
*                    `XR_BLE_SM_ONLY_ACCEPT_SPECIFIED_SEC_AUTH`).
*
...
*
* @param[out]      dev_list: an array(buffer) of `xr_ble_bond_dev_t` type. Use for storing the bonded devices address.
...
*                  SMP in response to XR_GAP_BLE_OOB_REQ_EVT
*
* @param[in]       bd_addr: BD address of the peer device.
...
*                  xr_ble_gattc_close (xr_gatt_if_t gattc_if, uint16_t conn_id) only close one virtual GATT server connection.
*                  if there exist other virtual GATT server connections, it does not disconnect the physical connection.
*                  xr_ble_gap_disconnect(xr_bd_addr_t remote_device) disconnect the physical connection directly.
*
*
*
