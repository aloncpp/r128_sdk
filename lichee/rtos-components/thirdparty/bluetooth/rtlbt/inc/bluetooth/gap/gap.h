...
#endif
#if F_BT_LE_SUPPORT
#define GAP_AUTHEN_BIT_MITM_LE_FLAG          0x0800 //!<  Mitm is preferred for LE is required
#endif
#if F_BT_BREDR_SUPPORT
#define GAP_AUTHEN_BIT_MITM_BR_FLAG          0x1000 //!<  Mitm is preferred for BR/EDR is required
#endif
