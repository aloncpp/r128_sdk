...
/**
 * \defgroup    GAP_LEGACY_STORAGE      GAP Legacy Storage
 *
 ...
 *
 * \name  GAP_LEGACY_BOND_FLAG
 * \brief GAP legacy bond flag.
 * \anchor  GAP_LEGACY_BOND_FLAG
 */
/**
 * \ingroup     GAP_LEGACY_STORAGE
 */
/**@{*/
#define BOND_FLAG_HFHS                  0x01    /**< GAP legacy bond flag HFP or HSP support. */
#define BOND_FLAG_A2DP                  0x02    /**< GAP legacy bond flag A2DP support. */
#define BOND_FLAG_SPP                   0x04    /**< GAP legacy bond flag SPP support. */
#define BOND_FLAG_PBAP                  0x08    /**< GAP legacy bond flag PBAP support. */
#define BOND_FLAG_CONTENT_PROTECTION    0x10    /**< GAP legacy bond flag content protection support. */
#define BOND_FLAG_DELAY_REPORT          0x20    /**< GAP legacy bond flag delay report support. */
#define BOND_FLAG_RWS                   0x40    /**< GAP legacy bond flag RWS support. */
#define BOND_FLAG_PAIRED                0x80    /**< GAP legacy bond flag device already paired. */
/**@}*/
 ...
 *
 * \param[in]   bd_addr     Bluetooth address of the device.
 * \param[out]  link_key    Address of link key.
 * \param[out]  key_type    Link key type.
 *
 ...
 *
 * \param[in]   bd_addr     Bluetooth address of the device.
 * \param[in]   value       Bond flag value to be set.
 *
 ...
 * \ingroup  GAP_LEGACY_STORAGE
 */
bool legacy_set_bond_flag(uint8_t *bd_addr, uint32_t value);
 ...
 * \param[in]   bd_addr     Bluetooth address of the device.
 *
 * \return      Bond flag of the address.
 *
 * <b>Example usage</b>
   \code{.c}
   int test(void)
 ...
 * \ingroup  GAP_LEGACY_STORAGE
 */
uint32_t legacy_get_bond_flag(uint8_t *bd_addr);
