...
#define BTIF_AUTHEN_MITM_LE                  0x0800 /**< LE MITM support. */
#define BTIF_AUTHEN_MITM_BR                  0x1000 /**< BR/EDR MITM support. */
...
typedef enum
{
    ...
    BTIF_DEV_CFG_OP_SSP_DEBUG_MODE
...
typedef enum
{
    ...
    BTIF_ACL_LINK_KEY_NOTIF     = 0x12   /**< ACL link key notification event is received. */
} T_BTIF_ACL_STATUS;
...
typedef enum
{
    BTIF_POWER_STATE_ON           = 0,   /**< BT power on */
    BTIF_POWER_STATE_START_ON     = 1,   /**< Start turn on the power */
    BTIF_POWER_STATE_OFF          = 2,   /**< BT power off */
    BTIF_POWER_STATE_START_OFF    = 3    /**< Start turn off the power */
} T_BTIF_POWER_STATE;
#endif
/**
 * btif.h
...
typedef enum
{
    ...
    BTIF_MSG_LE_FIX_CHANN_REG_REQ,
    BTIF_MSG_LE_FIX_CHANN_REG_RSP,
    BTIF_MSG_LE_FIX_CHANN_DATA_REQ,
    BTIF_MSG_LE_FIX_CHANN_DATA_RSP,
    BTIF_MSG_LE_FIX_CHANN_DATA_IND,
    BTIF_MSG_LE_FIX_CHANN_DATA_CFM,
    ...
    BTIF_MSG_SCO_PARAM_CHANGE_REQ,
    BTIF_MSG_SCO_PARAM_CHANGE_RSP,
    BTIF_MSG_SCO_PARAM_CHANGE_INFO,
    ...
    BTIF_MSG_CSB_TX_CMPL_INFO,

    BTIF_MSG_HANDOVER_INFO_GET_REQ,
    BTIF_MSG_HANDOVER_INFO_GET_RSP,
    BTIF_MSG_HANDOVER_INFO_SET_REQ,
    BTIF_MSG_HANDOVER_INFO_SET_RSP,
    BTIF_MSG_HANDOVER_INFO_DEL_REQ,
    BTIF_MSG_HANDOVER_INFO_DEL_RSP,

    BTIF_MSG_ACL_LINK_POLICY_REQ,
    BTIF_MSG_ACL_LINK_POLICY_RSP,
    BTIF_MSG_ACL_LINK_SUPV_TOUT_REQ,
    BTIF_MSG_ACL_LINK_SUPV_TOUT_RSP,
    BTIF_MSG_ACL_LINK_ROLE_REQ,
    BTIF_MSG_ACL_LINK_ROLE_RSP,
    BTIF_MSG_ACL_PKT_TYPE_REQ,
    BTIF_MSG_ACL_PKT_TYPE_RSP,
    BTIF_MSG_ACL_FLUSH_TOUT_REQ,
    BTIF_MSG_ACL_FLUSH_TOUT_RSP,
    BTIF_MSG_ACL_ENTER_SNIFF_REQ,
    BTIF_MSG_ACL_ENTER_SNIFF_RSP,
    BTIF_MSG_ACL_EXIT_SNIFF_REQ,
    BTIF_MSG_ACL_EXIT_SNIFF_RSP,

//for bt lib
    BTIF_MSG_BT_POWER_ON_REQ = 0x2000,
    BTIF_MSG_BT_POWER_ON_RSP,
    BTIF_MSG_BT_POWER_OFF_REQ,
    BTIF_MSG_BT_POWER_OFF_RSP,
 ...
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_LINK_POLICY_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
 ...
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_LINK_SUPV_TOUT_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
 ...
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_LINK_ROLE_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
...
typedef struct
{
    uint8_t         bd_addr[6]; /**< Bluetooth address of remote device. */
    uint16_t        cause;      /**< Result of configuring ACL link. */
} T_BTIF_ACL_PKT_TYPE_RSP;

/**
 * btif.h
 *
 * \brief    Response of configuring ACL link flush timeout. It will be received in the callback
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_FLUSH_TOUT_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
{
    uint8_t         bd_addr[6]; /**< Bluetooth address of remote device. */
    uint16_t        cause;      /**< Result of configuring ACL link. */
} T_BTIF_ACL_FLUSH_TOUT_RSP;

/**
 * btif.h
 *
 * \brief    Response of configuring ACL link to enter sniff mode. It will be received in the callback
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_ENTER_SNIFF_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
{
    uint8_t                     bd_addr[6]; /**< Bluetooth address of remote device. */
    uint16_t                    cause;      /**< Result of configuring ACL link. */
} T_BTIF_ACL_ENTER_SNIFF_RSP;

/**
 * btif.h
 *
 * \brief    Response of configuring ACL link to exit sniff mode. It will be received in the callback
 *           function registered by \ref btif_register_req with message type as
 *           \ref BTIF_MSG_ACL_EXIT_SNIFF_RSP.
 *
 * \ingroup  BTIF
 */
typedef struct
...
{
    uint16_t                    cause;
    T_GAP_HANDOVER_TYPE         type;
    union
    {
        T_GAP_HANDOVER_ACL_INFO acl;
        T_GAP_HANDOVER_SM_INFO  sm;
        T_GAP_HANDOVER_L2C_INFO l2c;
        T_GAP_HANDOVER_SCO_INFO sco;
    } u;
} T_BTIF_HANDOVER_INFO_GET_RSP;

typedef struct
{
    uint16_t                cause;
    T_GAP_HANDOVER_TYPE     type;
} T_BTIF_HANDOVER_INFO_SET_RSP;

typedef struct
{
    uint16_t                cause;
    T_GAP_HANDOVER_TYPE     type;
} T_BTIF_HANDOVER_INFO_DEL_RSP;

#if F_BT_CONTROLLER_POWER_CONTROL
typedef struct
{
    uint16_t                cause;
} T_BTIF_BT_POWER_ON_RSP;

typedef struct
{
    uint16_t                cause;
} T_BTIF_BT_POWER_OFF_RSP;
#endif
...
typedef union
{
    ...
    T_BTIF_LE_FIX_CHANN_REG_RSP                     le_fix_chann_reg_rsp;
    T_BTIF_LE_FIX_CHANN_DATA_RSP                    le_fix_chann_data_rsp;
    T_BTIF_LE_FIX_CHANN_DATA_IND                    le_fix_chann_data_ind;
    ...
    T_BTIF_ACL_LINK_POLICY_RSP          acl_link_policy_rsp;
    T_BTIF_ACL_LINK_SUPV_TOUT_RSP       acl_link_supv_tout_rsp;
    T_BTIF_ACL_LINK_ROLE_RSP            acl_link_role_rsp;
    T_BTIF_ACL_PKT_TYPE_RSP             acl_pkt_type_rsp;
    T_BTIF_ACL_FLUSH_TOUT_RSP           acl_flush_tout_rsp;
    T_BTIF_ACL_ENTER_SNIFF_RSP          acl_enter_sniff_rsp;
    T_BTIF_ACL_EXIT_SNIFF_RSP           acl_exit_sniff_rsp;
    ...
    T_BTIF_SCO_PARAM_CHANGE_RSP         sco_param_change_rsp;
    T_BTIF_SCO_PARAM_CHANGE_INFO        sco_param_change_info;
    ...
    T_BTIF_HANDOVER_INFO_GET_RSP        handover_info_get_rsp;
    T_BTIF_HANDOVER_INFO_SET_RSP        handover_info_set_rsp;
    T_BTIF_HANDOVER_INFO_DEL_RSP        handover_info_del_rsp;
#endif
#if F_BT_CONTROLLER_POWER_CONTROL
    T_BTIF_BT_POWER_ON_RSP              bt_power_on_rsp;
    T_BTIF_BT_POWER_OFF_RSP             bt_power_off_rsp;
#endif
} T_BTIF_UP_MSG_DATA;
...
bool btif_check_stack_ready(void);
/**
 * btif.h
 *
...
bool btif_set_link_key_convert(uint8_t convert_flag);
#if PATCH_CODE_EN
...
void btif_le_cfg_sign_key_flag(bool enable);
...
bool btif_le_write_default_data_len_req(uint16_t tx_oct, uint16_t tx_time);
...
bool btif_le_fix_chann_reg_req(uint16_t cid);

bool btif_le_fix_chann_data_req(void *p_buf, uint16_t link_id, uint16_t cid,
                                uint16_t length, uint16_t offset);

bool btif_le_fix_chann_data_cfm(uint16_t link_id, uint16_t cid, T_BTIF_CAUSE cause);
 ...
 * \ingroup  BTIF
 */
bool btif_dev_ext_eir_cfg_req(uint8_t *p_data, uint8_t data_len);
 ...
 * \ingroup  BTIF
 */
bool btif_dev_link_policy_cfg_req(uint16_t policy, uint16_t supv_tout);
...
bool btif_dev_ssp_debug_mode_cfg_req(bool enable);
       ...
       case BTIF_MSG_SDP_ATTR_IND:
           {
               ...
               btif_sdp_attr_cfm(p_ind->bd_addr, BTIF_CAUSE_SUCCESS);
           }
           break;
 ...
 * \ingroup  BTIF
 */
bool btif_sdp_attr_cfm(uint8_t *bd_addr, T_BTIF_CAUSE cause);
       ...
       case BTIF_MSG_DID_ATTR_IND:
           {
               ...
               btif_did_attr_cfm(p_ind->bd_addr, BTIF_CAUSE_SUCCESS);
           }
           break;
 ...
 * \ingroup  BTIF
 */
bool btif_did_attr_cfm(uint8_t *bd_addr, T_BTIF_CAUSE cause);
 ...
 *           request was successfully sent, a message whose type is \ref BTIF_MSG_ACL_LINK_POLICY_RSP
 *           and data is \ref BTIF_MSG_ACL_LINK_POLICY_RSP will be received in the callback
 *           function registered by \ref btif_register_req. Bluetooth
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_LINK_POLICY_RSP:
               {
               T_BTIF_ACL_LINK_POLICY_RSP *p_rsp = &p_msg->p.acl_link_policy_rsp;
 ...
 * \ingroup  BTIF
 */
bool btif_acl_link_policy_cfg_req(uint8_t *bd_addr, uint16_t policy);
 ...
 *           is \ref BTIF_MSG_ACL_LINK_SUPV_TOUT_RSP and data is \ref T_BTIF_ACL_LINK_SUPV_TOUT_RSP
 *           will be received in the callback function registered by \ref btif_register_req.
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_LINK_SUPV_TOUT_RSP:
               {
               T_BTIF_ACL_LINK_SUPV_TOUT_RSP *p_rsp = &p_msg->p.acl_link_supv_tout_rsp;
 ...
 *           was successfully sent, a message whose type is \ref BTIF_MSG_ACL_LINK_ROLE_RSP
 *           and data is \ref T_BTIF_ACL_LINK_ROLE_RSP will be received in the callback
 *           function registered by \ref btif_register_req. If switch
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_LINK_ROLE_RSP:
               {
               T_BTIF_ACL_LINK_ROLE_RSP *p_rsp = &p_msg->p.acl_link_role_rsp;
 ...
 *           was successfully sent, a message whose type is \ref BTIF_MSG_ACL_PKT_TYPE_RSP
 *           and data is \ref T_BTIF_ACL_PKT_TYPE_RSP will be received in the callback
 *           function registered by \ref btif_register_req. BT stack
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_PKT_TYPE_RSP:
               {
               T_BTIF_ACL_PKT_TYPE_RSP *p_rsp = &p_msg->p.acl_pkt_type_rsp;
 ...
 *           \ref BTIF_MSG_ACL_ENTER_SNIFF_RSP and data is \ref T_BTIF_ACL_ENTER_SNIFF_RSP will
 *           be received in the callback function registered by \ref btif_register_req.
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_STATUS_INFO:
           {
               ...
               {
               case BTIF_ACL_CONN_READY:
                   btif_acl_sniff_mode_enter_req(p_info->bd_addr, 192, 800, 4, 2);
                   break;
       ...
       case BTIF_MSG_ACL_ENTER_SNIFF_RSP:
               {
               T_BTIF_ACL_ENTER_SNIFF_RSP *p_rsp = &p_msg->p.acl_enter_sniff_rsp;
 ...
 *           mode. If the request was successfully sent, a message whose type is
 *           \ref BTIF_MSG_ACL_EXIT_SNIFF_RSP and data is \ref T_BTIF_ACL_EXIT_SNIFF_RSP will
 *           be received in the callback function registered by \ref btif_register_req.
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_EXIT_SNIFF_RSP:
               {
               T_BTIF_ACL_EXIT_SNIFF_RSP *p_rsp = &p_msg->p.acl_exit_sniff_rsp;
 ...
 * btif.h
 *
 * \brief    Send a request to configure link flush timeout value for an ACL link. If the request
 *           was successfully sent, a message whose type is \ref BTIF_MSG_ACL_FLUSH_TOUT_RSP and data is
 *           \ref T_BTIF_ACL_FLUSH_TOUT_RSP will be received in the callback function registered by
 *           \ref btif_register_req.
 *
 * \param[in]  bd_addr             Bluetooth address of remote device.
 ...
 * <b>Example usage</b>
   ...
   void app_handle_btif_msg(T_BTIF_UP_MSG *p_msg)
   {
       ...
       case BTIF_MSG_ACL_STATUS_INFO:
           {
               ...
               {
               case BTIF_ACL_CONN_READY:
                   btif_acl_link_flush_tout_cfg_req(p_info->bd_addr, 0x00FF);
                   break;
       ...
       case BTIF_MSG_ACL_FLUSH_TOUT_RSP:
               {
               T_BTIF_ACL_FLUSH_TOUT_RSP *p_rsp = &p_msg->p.acl_flush_tout_rsp;
                   APP_PRINT_TRACE1("Configure ACL link flush timeout response: cause 0x%04x", p_rsp->cause);
               }
           break;
 ...
 * \ingroup  BTIF
 */
bool btif_acl_link_flush_tout_cfg_req(uint8_t *bd_addr, uint16_t flush_tout);
...
void *btif_get_sys_buf(uint16_t size, uint16_t offset);
...
bool btif_sco_param_change_req(uint16_t handle, uint32_t tx_bandwidth, uint32_t rx_bandwidth,
                               uint16_t max_latency, uint16_t voice_setting, uint8_t retrans_effort, uint16_t packet_type);
...
bool btif_handover_info_get_req(T_GAP_HANDOVER_TYPE type, uint8_t *bd_addr, uint16_t cid);

bool btif_handover_info_set_req(T_GAP_HANDOVER_TYPE type, uint8_t *p_info, uint16_t len);

bool btif_handover_info_del_req(T_GAP_HANDOVER_TYPE type, uint8_t *bd_addr, uint16_t cid);

uint8_t *btif_find_sdp_attr(uint8_t *p_start, uint8_t *p_end, uint32_t attr_value);

uint32_t btif_get_sdp_value(uint8_t *p_start, uint8_t *p_end);

bool btif_get_sdp_uuid_value(uint8_t *p_start, uint8_t *p_end, T_BTIF_UUID_TYPE *p_type,
                             T_BTIF_UUID_DATA *p_data);

uint8_t *btif_access_sdp_elem(uint8_t *p_start, uint8_t *p_end, uint16_t index);
#if F_BT_CONTROLLER_POWER_CONTROL
bool btif_bt_power_on_req(void);
bool btif_bt_power_off_req(void);
#endif
