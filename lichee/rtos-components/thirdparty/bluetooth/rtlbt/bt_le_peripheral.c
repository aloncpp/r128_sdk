...
/** @defgroup  BLE_PERIPHERAL Peripheral Application
    * @brief This file handles BLE peripheral application routines.
    * @{
    */
/*============================================================================*
...
bool le_stack_ready = false;
bt_gatt_service_conn_state_cb gatts_service_conn_cb = NULL;
...
void app_handle_conn_state_evt(uint8_t conn_id, T_GAP_CONN_STATE new_state, uint16_t disc_cause)
{
    ...
    if (gatts_service_conn_cb != NULL)
    {
        gatts_service_conn_cb(conn_id, new_state, disc_cause);
    }
...
T_APP_RESULT app_profile_callback(T_SERVER_ID service_id, void *p_data)
{
    ...
    APP_PRINT_INFO0("app_profile_callback");
...
void bt_gatt_service_set_conn_state_cb_func(bt_gatt_service_conn_state_cb func)
{
    gatts_service_conn_cb = func;
}

bool is_le_stack_ready(void)
{
    return le_stack_ready;
}

/** @defgroup  BLE_PERIPHERAL_INIT Profile Server Callback Event Handler
    * @brief Handle profile server callback event
    * @{
    */
/**
    * @brief    init func for ble in app
    * @note     Then the event handling function shall be called according to the
    *           service_id
    * @param    void
    * @return   void
...
void bt_le_peripheral_init(void)
{
    APP_PRINT_INFO0("bt_le_peripheral_init");
    le_register_app_cb(app_gap_callback);
    server_init(BT_GATT_SERVER_MAX_NUM);
    //ali_add_service(NULL);
}


/** @} */ /* End of group BLE_PERIPHERAL */
