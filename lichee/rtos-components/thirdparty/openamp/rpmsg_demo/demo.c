...
static int cmd_rpmsg_demo(int argc, char *argv[])
{
	...
	demo_thread = hal_thread_create(cmd_rpmsg_demo_thread, NULL, "rpmsg_demo", HAL_THREAD_STACK_SIZE, HAL_THREAD_PRIORITY);
	if(demo_thread != NULL)
		hal_thread_start(demo_thread);
