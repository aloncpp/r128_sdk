...
__attribute__((constructor)) static int openamp_sunxi_mutex_create(void)
{
...
__attribute__((destructor)) static void sunxi_rprocs_add_rproc(struct openamp_sunxi_rproc *rproc)
{
		...
		rpmsg_ns_bind_cb ns_bind_cb)
{
	...
	openamp_dbg("shm_io virt:0x%p physmap:0x%lx\r\n", shm_io->virt, *(shm_io->physmap));
