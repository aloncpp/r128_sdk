...
#define RPBUF_MEASURE_TIME_RESERVED			(sizeof(uint32_t) * 16)
#define RPBUF_TRACE_START					(0)
#define RPBUF_TRACE_FLUSH					(1)			/* flush cache */
#define RPBUF_TRACE_NOTIFY					(2)			/* send notify to remote */
#define RPBUF_TRACE_WAIT_ACK				(3)			/* wait remote ack */
#define RPBUF_TRACE_R_NOTIFY				(4)			/* remote service received notify */
#define RPBUF_TRACE_R_S_CB					(5)			/* remote service start calling cb */
#define RPBUF_TRACE_R_S_NOTIFY				(6)			/* remote service send notify */
#define RPBUF_TRACE_R_FINISH				(7)			/* remote service process finish */
#define RPBUF_TRACE_END						(8)
